...
cat(int fd)
{
  ...
  44:	92058593          	addi	a1,a1,-1760 # 960 <lock_release+0x16>
  48:	4509                	li	a0,2
  ...
  72:	90a58593          	addi	a1,a1,-1782 # 978 <lock_release+0x2e>
  76:	4509                	li	a0,2
...
main(int argc, char *argv[])
{
 ...
 106:	88e58593          	addi	a1,a1,-1906 # 990 <lock_release+0x46>
 10a:	4509                	li	a0,2
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 558:	45cb8b93          	addi	s7,s7,1116 # 9b0 <digits>
 ...
 698:	31490913          	addi	s2,s2,788 # 9a8 <lock_release+0x5e>
        while(*s != 0){
...
void *thread_create(void*(start_routine)(void*),void *arg)
{
 ...
 8d8:	03451793          	slli	a5,a0,0x34
 8dc:	c791                	beqz	a5,8e8 <thread_create+0x2a>
 8de:	0347d713          	srli	a4,a5,0x34
	{
		stack = stack + (4096U - (uint64)stack%4096U);
 8e2:	6785                	lui	a5,0x1
 8e4:	8f99                	sub	a5,a5,a4
 ...
 8f2:	b46080e7          	jalr	-1210(ra) # 434 <clone>
 8f6:	85aa                	mv	a1,a0
	if(tid<0)
 8f8:	02055163          	bgez	a0,91a <thread_create+0x5c>
	{
		printf("Clone failed\n",tid);
 8fc:	00000517          	auipc	a0,0x0
 900:	0cc50513          	addi	a0,a0,204 # 9c8 <digits+0x18>
 ...
 91e:	b22080e7          	jalr	-1246(ra) # 43c <texit>

0000000000000922 <lock_init>:
...
void lock_acquire(lock_t *lock)
{
 ...
 93a:	4705                	li	a4,1
 93c:	87ba                	mv	a5,a4
 93e:	0cf537af          	amoswap.d.aq	a5,a5,(a0)
 942:	ffed                	bnez	a5,93c <lock_acquire+0x8>
            ;
}
 944:	6422                	ld	s0,8(sp)
