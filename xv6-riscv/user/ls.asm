...
fmtname(char *path)
{
  ...
  6a:	b5298993          	addi	s3,s3,-1198 # bb8 <buf.1128>
...
ls(char *path)
{
 ...
 128:	a1c50513          	addi	a0,a0,-1508 # b40 <lock_release+0x40>
 ...
 166:	9ae58593          	addi	a1,a1,-1618 # b10 <lock_release+0x10>
 16a:	4509                	li	a0,2
 ...
 17c:	9b058593          	addi	a1,a1,-1616 # b28 <lock_release+0x28>
 180:	4509                	li	a0,2
 ...
 1ae:	9a650513          	addi	a0,a0,-1626 # b50 <lock_release+0x50>
 ...
 1f4:	978a0a13          	addi	s4,s4,-1672 # b68 <lock_release+0x68>
        printf("ls: cannot stat %s\n", buf);
 1f8:	00001a97          	auipc	s5,0x1
 1fc:	930a8a93          	addi	s5,s5,-1744 # b28 <lock_release+0x28>
...
main(int argc, char *argv[])
{
 ...
 2be:	8be50513          	addi	a0,a0,-1858 # b78 <lock_release+0x78>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 642:	54a50513          	addi	a0,a0,1354 # b88 <digits>
 646:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 70e:	47eb8b93          	addi	s7,s7,1150 # b88 <digits>
 ...
 84e:	33690913          	addi	s2,s2,822 # b80 <lock_release+0x80>
        while(*s != 0){
...
free(void *ap)
{
 ...
 916:	29e7b783          	ld	a5,670(a5) # bb0 <freep>
 ...
 944:	00e6ea63          	bltu	a3,a4,958 <free+0x50>
{
 ...
 986:	22f73723          	sd	a5,558(a4) # bb0 <freep>
}
 98a:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 9b8:	1fc53503          	ld	a0,508(a0) # bb0 <freep>
 ...
 9e0:	1d490913          	addi	s2,s2,468 # bb0 <freep>
  if(p == (char*)-1)
 9e4:	5afd                	li	s5,-1
 9e6:	a88d                	j	a58 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 9e8:	00000797          	auipc	a5,0x0
 9ec:	1e078793          	addi	a5,a5,480 # bc8 <base>
 9f0:	00000717          	auipc	a4,0x0
 9f4:	1cf73023          	sd	a5,448(a4) # bb0 <freep>
 9f8:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 a1a:	18a73d23          	sd	a0,410(a4) # bb0 <freep>
      return (void*)(p + 1);
...
0000000000000a74 <thread_create>:
...
void *thread_create(void*(start_routine)(void*),void *arg)
{
 ...
 a8a:	f0a080e7          	jalr	-246(ra) # 990 <malloc>
	if((uint64)stack%4096U)
 a8e:	03451793          	slli	a5,a0,0x34
 a92:	c791                	beqz	a5,a9e <thread_create+0x2a>
 a94:	0347d713          	srli	a4,a5,0x34
	{
		stack = stack + (4096U - (uint64)stack%4096U);
 a98:	6785                	lui	a5,0x1
 a9a:	8f99                	sub	a5,a5,a4
 ...
 aa8:	b46080e7          	jalr	-1210(ra) # 5ea <clone>
 aac:	85aa                	mv	a1,a0
	if(tid<0)
 aae:	02055163          	bgez	a0,ad0 <thread_create+0x5c>
	{
		printf("Clone failed\n",tid);
 ab2:	00000517          	auipc	a0,0x0
 ab6:	0ee50513          	addi	a0,a0,238 # ba0 <digits+0x18>
 aba:	00000097          	auipc	ra,0x0
 abe:	e18080e7          	jalr	-488(ra) # 8d2 <printf>
		return 0;
	}
	texit();
	return 0;
 ...
 ad4:	b22080e7          	jalr	-1246(ra) # 5f2 <texit>

0000000000000ad8 <lock_init>:
...
void lock_acquire(lock_t *lock)
{
 ...
 af0:	4705                	li	a4,1
 af2:	87ba                	mv	a5,a4
 af4:	0cf537af          	amoswap.d.aq	a5,a5,(a0)
 af8:	ffed                	bnez	a5,af2 <lock_acquire+0x8>
            ;
}
 afa:	6422                	ld	s0,8(sp)
