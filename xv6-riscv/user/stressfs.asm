...
main(int argc, char *argv[])
{
  ...
  1a:	96278793          	addi	a5,a5,-1694 # 978 <lock_release+0x40>
  1e:	6398                	ld	a4,0(a5)
  ...
  30:	91c50513          	addi	a0,a0,-1764 # 948 <lock_release+0x10>
  ...
  6c:	8f850513          	addi	a0,a0,-1800 # 960 <lock_release+0x28>
...
//    printf(fd, "%d\n", i);
  ...
  ba:	8ba50513          	addi	a0,a0,-1862 # 970 <lock_release+0x38>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 47a:	51a50513          	addi	a0,a0,1306 # 990 <digits>
 47e:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 546:	44eb8b93          	addi	s7,s7,1102 # 990 <digits>
 ...
 686:	30690913          	addi	s2,s2,774 # 988 <lock_release+0x50>
        while(*s != 0){
...
free(void *ap)
{
 ...
 74e:	26e7b783          	ld	a5,622(a5) # 9b8 <freep>
...
malloc(uint nbytes)
{
 ...
 7f0:	1cc53503          	ld	a0,460(a0) # 9b8 <freep>
 ...
 818:	1a490913          	addi	s2,s2,420 # 9b8 <freep>
  if(p == (char*)-1)
 81c:	5afd                	li	s5,-1
 81e:	a88d                	j	890 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 820:	00000797          	auipc	a5,0x0
 824:	1a078793          	addi	a5,a5,416 # 9c0 <base>
 828:	00000717          	auipc	a4,0x0
 82c:	18f73823          	sd	a5,400(a4) # 9b8 <freep>
 830:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 852:	16a73523          	sd	a0,362(a4) # 9b8 <freep>
      return (void*)(p + 1);
...
00000000000008ac <thread_create>:
#include "kernel/fcntl.h"
#include "user/user.h"
...
void *thread_create(void*(start_routine)(void*),void *arg)
{
 ...
 8c2:	f0a080e7          	jalr	-246(ra) # 7c8 <malloc>
	if((uint64)stack%4096U)
 8c6:	03451793          	slli	a5,a0,0x34
 8ca:	c791                	beqz	a5,8d6 <thread_create+0x2a>
 8cc:	0347d713          	srli	a4,a5,0x34
	{
		stack = stack + (4096U - (uint64)stack%4096U);
 8d0:	6785                	lui	a5,0x1
 8d2:	8f99                	sub	a5,a5,a4
 ...
 8e0:	b46080e7          	jalr	-1210(ra) # 422 <clone>
 8e4:	85aa                	mv	a1,a0
	if(tid<0)
 8e6:	02055163          	bgez	a0,908 <thread_create+0x5c>
	{
		printf("Clone failed\n",tid);
 8ea:	00000517          	auipc	a0,0x0
 8ee:	0be50513          	addi	a0,a0,190 # 9a8 <digits+0x18>
 8f2:	00000097          	auipc	ra,0x0
 8f6:	e18080e7          	jalr	-488(ra) # 70a <printf>
		return 0;
	}
	texit();
	return 0;
 ...
 90c:	b22080e7          	jalr	-1246(ra) # 42a <texit>
...
void lock_acquire(lock_t *lock)
{
 ...
 928:	4705                	li	a4,1
 92a:	87ba                	mv	a5,a4
 92c:	0cf537af          	amoswap.d.aq	a5,a5,(a0)
 930:	ffed                	bnez	a5,92a <lock_acquire+0x8>
            ;
}
 932:	6422                	ld	s0,8(sp)
