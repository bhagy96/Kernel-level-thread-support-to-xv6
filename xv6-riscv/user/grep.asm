...
00000000000001ee <main>:
{
 ...
 262:	89258593          	addi	a1,a1,-1902 # af0 <lock_release+0x16>
 266:	4509                	li	a0,2
 ...
 298:	87c50513          	addi	a0,a0,-1924 # b10 <lock_release+0x36>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 61c:	51850513          	addi	a0,a0,1304 # b30 <digits>
 620:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6e8:	44cb8b93          	addi	s7,s7,1100 # b30 <digits>
 ...
 828:	30490913          	addi	s2,s2,772 # b28 <lock_release+0x4e>
        while(*s != 0){
...
0000000000000a4e <thread_create>:
...
void *thread_create(void*(start_routine)(void*),void *arg)
{
 ...
 a64:	f0a080e7          	jalr	-246(ra) # 96a <malloc>
	if((uint64)stack%4096U)
 a68:	03451793          	slli	a5,a0,0x34
 a6c:	c791                	beqz	a5,a78 <thread_create+0x2a>
 a6e:	0347d713          	srli	a4,a5,0x34
	{
		stack = stack + (4096U - (uint64)stack%4096U);
 a72:	6785                	lui	a5,0x1
 a74:	8f99                	sub	a5,a5,a4
 ...
 a82:	b46080e7          	jalr	-1210(ra) # 5c4 <clone>
 a86:	85aa                	mv	a1,a0
	if(tid<0)
 a88:	02055163          	bgez	a0,aaa <thread_create+0x5c>
	{
		printf("Clone failed\n",tid);
 a8c:	00000517          	auipc	a0,0x0
 a90:	0bc50513          	addi	a0,a0,188 # b48 <digits+0x18>
 a94:	00000097          	auipc	ra,0x0
 a98:	e18080e7          	jalr	-488(ra) # 8ac <printf>
		return 0;
	}
	texit();
	return 0;
 ...
 aae:	b22080e7          	jalr	-1246(ra) # 5cc <texit>

0000000000000ab2 <lock_init>:
...
void lock_acquire(lock_t *lock)
{
 ...
 aca:	4705                	li	a4,1
 acc:	87ba                	mv	a5,a4
 ace:	0cf537af          	amoswap.d.aq	a5,a5,(a0)
 ad2:	ffed                	bnez	a5,acc <lock_acquire+0x8>
            ;
}
 ad4:	6422                	ld	s0,8(sp)
