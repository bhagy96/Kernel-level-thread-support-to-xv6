...
main(int argc, char **argv)
{
  ...
  4c:	85858593          	addi	a1,a1,-1960 # 8a0 <lock_release+0x10>
  50:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3d2:	4f250513          	addi	a0,a0,1266 # 8c0 <digits>
 3d6:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 49e:	426b8b93          	addi	s7,s7,1062 # 8c0 <digits>
 ...
 5de:	2de90913          	addi	s2,s2,734 # 8b8 <lock_release+0x28>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6a6:	2467b783          	ld	a5,582(a5) # 8e8 <freep>
 ...
 6d4:	00e6ea63          	bltu	a3,a4,6e8 <free+0x50>
{
 ...
 716:	1cf73b23          	sd	a5,470(a4) # 8e8 <freep>
}
 71a:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 748:	1a453503          	ld	a0,420(a0) # 8e8 <freep>
 ...
 770:	17c90913          	addi	s2,s2,380 # 8e8 <freep>
  if(p == (char*)-1)
 774:	5afd                	li	s5,-1
 776:	a88d                	j	7e8 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 778:	00000797          	auipc	a5,0x0
 77c:	17878793          	addi	a5,a5,376 # 8f0 <base>
 780:	00000717          	auipc	a4,0x0
 784:	16f73423          	sd	a5,360(a4) # 8e8 <freep>
 788:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7aa:	14a73123          	sd	a0,322(a4) # 8e8 <freep>
      return (void*)(p + 1);
...
0000000000000804 <thread_create>:
...
void *thread_create(void*(start_routine)(void*),void *arg)
{
 ...
 81a:	f0a080e7          	jalr	-246(ra) # 720 <malloc>
	if((uint64)stack%4096U)
 81e:	03451793          	slli	a5,a0,0x34
 822:	c791                	beqz	a5,82e <thread_create+0x2a>
 824:	0347d713          	srli	a4,a5,0x34
	{
		stack = stack + (4096U - (uint64)stack%4096U);
 828:	6785                	lui	a5,0x1
 82a:	8f99                	sub	a5,a5,a4
 82c:	953e                	add	a0,a0,a5
	}
	int size = 8;
 ...
 838:	b46080e7          	jalr	-1210(ra) # 37a <clone>
 83c:	85aa                	mv	a1,a0
	if(tid<0)
 83e:	02055163          	bgez	a0,860 <thread_create+0x5c>
	{
		printf("Clone failed\n",tid);
 842:	00000517          	auipc	a0,0x0
 846:	09650513          	addi	a0,a0,150 # 8d8 <digits+0x18>
 84a:	00000097          	auipc	ra,0x0
 84e:	e18080e7          	jalr	-488(ra) # 662 <printf>
		return 0;
	}
	texit();
	return 0;
 ...
 864:	b22080e7          	jalr	-1246(ra) # 382 <texit>
...
void lock_acquire(lock_t *lock)
{
 ...
 880:	4705                	li	a4,1
 882:	87ba                	mv	a5,a4
 884:	0cf537af          	amoswap.d.aq	a5,a5,(a0)
 888:	ffed                	bnez	a5,882 <lock_acquire+0x8>
            ;
}
 88a:	6422                	ld	s0,8(sp)
