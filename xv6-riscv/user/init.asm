...
main(void)
{
  ...
  12:	92a50513          	addi	a0,a0,-1750 # 938 <lock_release+0x14>
  ...
  3a:	90a90913          	addi	s2,s2,-1782 # 940 <lock_release+0x1c>
  3e:	854a                	mv	a0,s2
  ...
  6e:	92650513          	addi	a0,a0,-1754 # 990 <lock_release+0x6c>
  ...
  8c:	8b050513          	addi	a0,a0,-1872 # 938 <lock_release+0x14>
  90:	00000097          	auipc	ra,0x0
  94:	326080e7          	jalr	806(ra) # 3b6 <mknod>
    open("console", O_RDWR);
  98:	4589                	li	a1,2
  9a:	00001517          	auipc	a0,0x1
  9e:	89e50513          	addi	a0,a0,-1890 # 938 <lock_release+0x14>
  a2:	00000097          	auipc	ra,0x0
  a6:	30c080e7          	jalr	780(ra) # 3ae <open>
  aa:	bfa5                	j	22 <main+0x22>
      printf("init: fork failed\n");
  ac:	00001517          	auipc	a0,0x1
  b0:	8ac50513          	addi	a0,a0,-1876 # 958 <lock_release+0x34>
  ...
  ca:	91a58593          	addi	a1,a1,-1766 # 9e0 <argv>
  ce:	00001517          	auipc	a0,0x1
  d2:	8a250513          	addi	a0,a0,-1886 # 970 <lock_release+0x4c>
  d6:	00000097          	auipc	ra,0x0
  da:	2d0080e7          	jalr	720(ra) # 3a6 <exec>
      printf("init: exec sh failed\n");
  de:	00001517          	auipc	a0,0x1
  e2:	89a50513          	addi	a0,a0,-1894 # 978 <lock_release+0x54>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 466:	55650513          	addi	a0,a0,1366 # 9b8 <digits>
 46a:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 532:	48ab8b93          	addi	s7,s7,1162 # 9b8 <digits>
 ...
 672:	34290913          	addi	s2,s2,834 # 9b0 <lock_release+0x8c>
        while(*s != 0){
...
free(void *ap)
{
 ...
 73a:	2ba7b783          	ld	a5,698(a5) # 9f0 <freep>
 ...
 768:	00e6ea63          	bltu	a3,a4,77c <free+0x50>
{
 ...
 7aa:	24f73523          	sd	a5,586(a4) # 9f0 <freep>
}
 7ae:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7dc:	21853503          	ld	a0,536(a0) # 9f0 <freep>
 ...
 804:	1f090913          	addi	s2,s2,496 # 9f0 <freep>
  if(p == (char*)-1)
 808:	5afd                	li	s5,-1
 80a:	a88d                	j	87c <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 80c:	00000797          	auipc	a5,0x0
 810:	1ec78793          	addi	a5,a5,492 # 9f8 <base>
 814:	00000717          	auipc	a4,0x0
 818:	1cf73e23          	sd	a5,476(a4) # 9f0 <freep>
 81c:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 83e:	1aa73b23          	sd	a0,438(a4) # 9f0 <freep>
      return (void*)(p + 1);
...
0000000000000898 <thread_create>:
...
void *thread_create(void*(start_routine)(void*),void *arg)
{
 ...
 8ae:	f0a080e7          	jalr	-246(ra) # 7b4 <malloc>
	if((uint64)stack%4096U)
 8b2:	03451793          	slli	a5,a0,0x34
 8b6:	c791                	beqz	a5,8c2 <thread_create+0x2a>
 8b8:	0347d713          	srli	a4,a5,0x34
	{
		stack = stack + (4096U - (uint64)stack%4096U);
 8bc:	6785                	lui	a5,0x1
 8be:	8f99                	sub	a5,a5,a4
 8c0:	953e                	add	a0,a0,a5
	}
	int size = 8;
 ...
 8cc:	b46080e7          	jalr	-1210(ra) # 40e <clone>
 8d0:	85aa                	mv	a1,a0
	if(tid<0)
 8d2:	02055163          	bgez	a0,8f4 <thread_create+0x5c>
	{
		printf("Clone failed\n",tid);
 8d6:	00000517          	auipc	a0,0x0
 8da:	0fa50513          	addi	a0,a0,250 # 9d0 <digits+0x18>
 8de:	00000097          	auipc	ra,0x0
 8e2:	e18080e7          	jalr	-488(ra) # 6f6 <printf>
		return 0;
	}
	texit();
	return 0;
 ...
 8f8:	b22080e7          	jalr	-1246(ra) # 416 <texit>

00000000000008fc <lock_init>:
...
void lock_acquire(lock_t *lock)
{
 ...
 914:	4705                	li	a4,1
 916:	87ba                	mv	a5,a4
 918:	0cf537af          	amoswap.d.aq	a5,a5,(a0)
 91c:	ffed                	bnez	a5,916 <lock_acquire+0x8>
            ;
}
 91e:	6422                	ld	s0,8(sp)
