...
getcmd(char *buf, int nbuf)
{
  ...
  fprintf(2, "$ ");
      ...
      14:	38058593          	addi	a1,a1,896 # 1390 <lock_release+0x10>
      18:	4509                	li	a0,2
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      62:	33a58593          	addi	a1,a1,826 # 1398 <lock_release+0x18>
      66:	4509                	li	a0,2
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      9c:	30850513          	addi	a0,a0,776 # 13a0 <lock_release+0x20>
...
00000000000000a8 <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      c8:	3dc70713          	addi	a4,a4,988 # 14a0 <lock_release+0x120>
    ...
    panic("runcmd");
      ...
      e2:	2ca50513          	addi	a0,a0,714 # 13a8 <lock_release+0x28>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     104:	2b058593          	addi	a1,a1,688 # 13b0 <lock_release+0x30>
     108:	4509                	li	a0,2
  ...
  exit(0);
    ...
    runcmd(rcmd->cmd);
     ...
     150:	27458593          	addi	a1,a1,628 # 13c0 <lock_release+0x40>
     154:	4509                	li	a0,2
    ...
    break;
     ...
     1e6:	1ee50513          	addi	a0,a0,494 # 13d0 <lock_release+0x50>
...
gettoken(char **ps, char *es, char **q, char **eq)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     3fe:	10e98993          	addi	s3,s3,270 # 1508 <whitespace>
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     462:	0aa98993          	addi	s3,s3,170 # 1508 <whitespace>
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     4cc:	04098993          	addi	s3,s3,64 # 1508 <whitespace>
     4d0:	00001a97          	auipc	s5,0x1
     4d4:	030a8a93          	addi	s5,s5,48 # 1500 <symbols>
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     536:	fd698993          	addi	s3,s3,-42 # 1508 <whitespace>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5a6:	e56b8b93          	addi	s7,s7,-426 # 13f8 <lock_release+0x78>
  ...
  while(peek(ps, es, "<>")){
     ...
     5b8:	e2450513          	addi	a0,a0,-476 # 13d8 <lock_release+0x58>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6a0:	d6460613          	addi	a2,a2,-668 # 1400 <lock_release+0x80>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6d0:	d54b0b13          	addi	s6,s6,-684 # 1420 <lock_release+0xa0>
  ...
  return ret;
     ...
     70a:	d0250513          	addi	a0,a0,-766 # 1408 <lock_release+0x88>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     76c:	ca850513          	addi	a0,a0,-856 # 1410 <lock_release+0x90>
...
0000000000000786 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7a6:	c8660613          	addi	a2,a2,-890 # 1428 <lock_release+0xa8>
     7aa:	85ce                	mv	a1,s3
     7ac:	854a                	mv	a0,s2
...
00000000000007f4 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     816:	c1ea0a13          	addi	s4,s4,-994 # 1430 <lock_release+0xb0>
     81a:	8652                	mv	a2,s4
     81c:	85ce                	mv	a1,s3
     81e:	854a                	mv	a0,s2
  ...
  if(peek(ps, es, ";")){
     ...
     84c:	bf060613          	addi	a2,a2,-1040 # 1438 <lock_release+0xb8>
     850:	85ce                	mv	a1,s3
     852:	854a                	mv	a0,s2
...
000000000000089c <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8b2:	b5260613          	addi	a2,a2,-1198 # 1400 <lock_release+0x80>
  ...
  if(!peek(ps, es, ")"))
     ...
     8e2:	b7260613          	addi	a2,a2,-1166 # 1450 <lock_release+0xd0>
     8e6:	85ca                	mv	a1,s2
     8e8:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     924:	b2050513          	addi	a0,a0,-1248 # 1440 <lock_release+0xc0>
     928:	fffff097          	auipc	ra,0xfffff
     92c:	72c080e7          	jalr	1836(ra) # 54 <panic>
    panic("syntax - missing )");
     930:	00001517          	auipc	a0,0x1
     934:	b2850513          	addi	a0,a0,-1240 # 1458 <lock_release+0xd8>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     960:	b5c70713          	addi	a4,a4,-1188 # 14b8 <lock_release+0x138>
...
00000000000009d8 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a0c:	a6860613          	addi	a2,a2,-1432 # 1470 <lock_release+0xf0>
     a10:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a42:	a3a58593          	addi	a1,a1,-1478 # 1478 <lock_release+0xf8>
     a46:	4509                	li	a0,2
     a48:	00000097          	auipc	ra,0x0
     a4c:	6dc080e7          	jalr	1756(ra) # 1124 <fprintf>
    panic("syntax");
     a50:	00001517          	auipc	a0,0x1
     a54:	9b850513          	addi	a0,a0,-1608 # 1408 <lock_release+0x88>
...
0000000000000a60 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a76:	a1648493          	addi	s1,s1,-1514 # 1488 <lock_release+0x108>
     a7a:	4589                	li	a1,2
     a7c:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     a9c:	a8048493          	addi	s1,s1,-1408 # 1518 <buf.1154>
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     aa0:	06300913          	li	s2,99
     aa4:	02000993          	li	s3,32
      if(chdir(buf+3) < 0)
     aa8:	00001a17          	auipc	s4,0x1
     aac:	a73a0a13          	addi	s4,s4,-1421 # 151b <buf.1154+0x3>
        fprintf(2, "cannot cd %s\n", buf+3);
     ab0:	00001a97          	auipc	s5,0x1
     ab4:	9e0a8a93          	addi	s5,s5,-1568 # 1490 <lock_release+0x110>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     b36:	9e650513          	addi	a0,a0,-1562 # 1518 <buf.1154>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     ec2:	61a50513          	addi	a0,a0,1562 # 14d8 <digits>
     ec6:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     f8e:	54eb8b93          	addi	s7,s7,1358 # 14d8 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    10ce:	40690913          	addi	s2,s2,1030 # 14d0 <lock_release+0x150>
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    1196:	37e7b783          	ld	a5,894(a5) # 1510 <freep>
    ...
    11c4:	00e6ea63          	bltu	a3,a4,11d8 <free+0x50>
{
  ...
  freep = p;
    ...
    1206:	30f73723          	sd	a5,782(a4) # 1510 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    1238:	2dc53503          	ld	a0,732(a0) # 1510 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    1260:	2b490913          	addi	s2,s2,692 # 1510 <freep>
  if(p == (char*)-1)
    1264:	5afd                	li	s5,-1
    1266:	a88d                	j	12d8 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
    1268:	00000797          	auipc	a5,0x0
    126c:	31878793          	addi	a5,a5,792 # 1580 <base>
    1270:	00000717          	auipc	a4,0x0
    1274:	2af73023          	sd	a5,672(a4) # 1510 <freep>
    ...
    129a:	26a73d23          	sd	a0,634(a4) # 1510 <freep>
      return (void*)(p + 1);
...
00000000000012f4 <thread_create>:
...
void *thread_create(void*(start_routine)(void*),void *arg)
{
    ...
    12fc:	e04a                	sd	s2,0(sp)
    12fe:	1000                	addi	s0,sp,32
    1300:	84aa                	mv	s1,a0
    1302:	892e                	mv	s2,a1
	void *stack = malloc(2*4096U);
    1304:	6509                	lui	a0,0x2
    1306:	00000097          	auipc	ra,0x0
    130a:	f0a080e7          	jalr	-246(ra) # 1210 <malloc>
	if((uint64)stack%4096U)
    130e:	03451793          	slli	a5,a0,0x34
    1312:	c791                	beqz	a5,131e <thread_create+0x2a>
    1314:	0347d713          	srli	a4,a5,0x34
	{
		stack = stack + (4096U - (uint64)stack%4096U);
    1318:	6785                	lui	a5,0x1
    131a:	8f99                	sub	a5,a5,a4
    131c:	953e                	add	a0,a0,a5
	}
	int size = 8;
    ...
    1328:	b46080e7          	jalr	-1210(ra) # e6a <clone>
    132c:	85aa                	mv	a1,a0
	if(tid<0)
    132e:	02055163          	bgez	a0,1350 <thread_create+0x5c>
	{
		printf("Clone failed\n",tid);
    1332:	00000517          	auipc	a0,0x0
    1336:	1be50513          	addi	a0,a0,446 # 14f0 <digits+0x18>
    133a:	00000097          	auipc	ra,0x0
    133e:	e18080e7          	jalr	-488(ra) # 1152 <printf>
		return 0;
	}
	texit();
	return 0;
    ...
    1348:	64a2                	ld	s1,8(sp)
    134a:	6902                	ld	s2,0(sp)
    134c:	6105                	addi	sp,sp,32
    134e:	8082                	ret
	texit();
    1350:	00000097          	auipc	ra,0x0
    1354:	b22080e7          	jalr	-1246(ra) # e72 <texit>
...
void lock_acquire(lock_t *lock)
{
    ...
    1370:	4705                	li	a4,1
    1372:	87ba                	mv	a5,a4
    1374:	0cf537af          	amoswap.d.aq	a5,a5,(a0)
    1378:	ffed                	bnez	a5,1372 <lock_acquire+0x8>
            ;
}
    137a:	6422                	ld	s0,8(sp)
    137c:	0141                	addi	sp,sp,16
    137e:	8082                	ret

0000000000001380 <lock_release>:
...
void lock_release(lock_t *lock){
	...
	lock->flag = 0;
    1386:	00053023          	sd	zero,0(a0)
}
    138a:	6422                	ld	s0,8(sp)
    138c:	0141                	addi	sp,sp,16
    138e:	8082                	ret
