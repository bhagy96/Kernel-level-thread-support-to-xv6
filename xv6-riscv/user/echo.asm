...
main(int argc, char *argv[])
{
  ...
  2e:	896a0a13          	addi	s4,s4,-1898 # 8c0 <lock_release+0x10>
    write(1, argv[i], strlen(argv[i]));
  ...
  6c:	86058593          	addi	a1,a1,-1952 # 8c8 <lock_release+0x18>
  70:	4505                	li	a0,1
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4be:	41eb8b93          	addi	s7,s7,1054 # 8d8 <digits>
 ...
 5fe:	2d690913          	addi	s2,s2,726 # 8d0 <lock_release+0x20>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6c6:	23e7b783          	ld	a5,574(a5) # 900 <freep>
 ...
 6f4:	00e6ea63          	bltu	a3,a4,708 <free+0x50>
{
 ...
 736:	1cf73723          	sd	a5,462(a4) # 900 <freep>
}
 73a:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 768:	19c53503          	ld	a0,412(a0) # 900 <freep>
 ...
 790:	17490913          	addi	s2,s2,372 # 900 <freep>
  if(p == (char*)-1)
 794:	5afd                	li	s5,-1
 796:	a88d                	j	808 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 798:	00000797          	auipc	a5,0x0
 79c:	17078793          	addi	a5,a5,368 # 908 <base>
 ...
 7ca:	12a73d23          	sd	a0,314(a4) # 900 <freep>
      return (void*)(p + 1);
...
0000000000000824 <thread_create>:
...
void *thread_create(void*(start_routine)(void*),void *arg)
{
 ...
 83a:	f0a080e7          	jalr	-246(ra) # 740 <malloc>
	if((uint64)stack%4096U)
 83e:	03451793          	slli	a5,a0,0x34
 842:	c791                	beqz	a5,84e <thread_create+0x2a>
 844:	0347d713          	srli	a4,a5,0x34
	{
		stack = stack + (4096U - (uint64)stack%4096U);
 848:	6785                	lui	a5,0x1
 84a:	8f99                	sub	a5,a5,a4
 84c:	953e                	add	a0,a0,a5
	}
	int size = 8;
 ...
 858:	b46080e7          	jalr	-1210(ra) # 39a <clone>
 85c:	85aa                	mv	a1,a0
	if(tid<0)
 85e:	02055163          	bgez	a0,880 <thread_create+0x5c>
	{
		printf("Clone failed\n",tid);
 862:	00000517          	auipc	a0,0x0
 866:	08e50513          	addi	a0,a0,142 # 8f0 <digits+0x18>
 ...
 884:	b22080e7          	jalr	-1246(ra) # 3a2 <texit>

0000000000000888 <lock_init>:
...
void lock_acquire(lock_t *lock)
{
 ...
 8a0:	4705                	li	a4,1
 8a2:	87ba                	mv	a5,a4
 8a4:	0cf537af          	amoswap.d.aq	a5,a5,(a0)
 8a8:	ffed                	bnez	a5,8a2 <lock_acquire+0x8>
            ;
}
 8aa:	6422                	ld	s0,8(sp)
