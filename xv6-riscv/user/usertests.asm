...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	13a50513          	addi	a0,a0,314 # 6178 <lock_release+0x370>
...
bsstest(char *s)
{
  ...
  for(i = 0; i < sizeof(uninit); i++){
      ...
      5c:	6e078793          	addi	a5,a5,1760 # 9738 <uninit>
      60:	0000c697          	auipc	a3,0xc
      64:	de868693          	addi	a3,a3,-536 # be48 <buf>
    if(uninit[i] != '\0'){
      ...
      74:	8082                	ret
{
      ...
      84:	11850513          	addi	a0,a0,280 # 6198 <lock_release+0x390>
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	10850513          	addi	a0,a0,264 # 61b0 <lock_release+0x3a8>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	10a50513          	addi	a0,a0,266 # 61d0 <lock_release+0x3c8>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	0d250513          	addi	a0,a0,210 # 61b8 <lock_release+0x3b0>
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	0de50513          	addi	a0,a0,222 # 61e0 <lock_release+0x3d8>
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	0dc50513          	addi	a0,a0,220 # 6208 <lock_release+0x400>
     134:	00005097          	auipc	ra,0x5
     138:	76e080e7          	jalr	1902(ra) # 58a2 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	0c850513          	addi	a0,a0,200 # 6208 <lock_release+0x400>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	0c458593          	addi	a1,a1,196 # 6218 <lock_release+0x410>
     15c:	00005097          	auipc	ra,0x5
     160:	716080e7          	jalr	1814(ra) # 5872 <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	0a050513          	addi	a0,a0,160 # 6208 <lock_release+0x400>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	0a458593          	addi	a1,a1,164 # 6220 <lock_release+0x418>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	07450513          	addi	a0,a0,116 # 6208 <lock_release+0x400>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	05e50513          	addi	a0,a0,94 # 6228 <lock_release+0x420>
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	d7c50513          	addi	a0,a0,-644 # 5ff8 <lock_release+0x1f0>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	d68a8a93          	addi	s5,s5,-664 # 5ff8 <lock_release+0x1f0>
      int cc = write(fd, buf, sz);
     298:	0000ca17          	auipc	s4,0xc
     29c:	bb0a0a13          	addi	s4,s4,-1104 # be48 <buf>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     2a0:	6b0d                	lui	s6,0x3
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	f3e50513          	addi	a0,a0,-194 # 6250 <lock_release+0x448>
     ...
     33a:	f3a50513          	addi	a0,a0,-198 # 6270 <lock_release+0x468>
...
0000000000000350 <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     376:	f16a0a13          	addi	s4,s4,-234 # 6288 <lock_release+0x480>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     422:	e7250513          	addi	a0,a0,-398 # 6290 <lock_release+0x488>
     ...
     440:	e6c50513          	addi	a0,a0,-404 # 62a8 <lock_release+0x4a0>
     ...
     45e:	e7e50513          	addi	a0,a0,-386 # 62d8 <lock_release+0x4d0>
     ...
     478:	e9450513          	addi	a0,a0,-364 # 6308 <lock_release+0x500>
     ...
     496:	e8650513          	addi	a0,a0,-378 # 6318 <lock_release+0x510>
...
00000000000004ac <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     4d4:	e78a0a13          	addi	s4,s4,-392 # 6348 <lock_release+0x540>
    n = write(fds[1], "x", 1);
     4d8:	00006a97          	auipc	s5,0x6
     4dc:	d48a8a93          	addi	s5,s5,-696 # 6220 <lock_release+0x418>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     582:	dd250513          	addi	a0,a0,-558 # 6350 <lock_release+0x548>
     ...
     5a0:	dcc50513          	addi	a0,a0,-564 # 6368 <lock_release+0x560>
     ...
     5ba:	d5250513          	addi	a0,a0,-686 # 6308 <lock_release+0x500>
     ...
     5d4:	dc850513          	addi	a0,a0,-568 # 6398 <lock_release+0x590>
     ...
     5f2:	dc250513          	addi	a0,a0,-574 # 63b0 <lock_release+0x5a8>
...
0000000000000608 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     648:	bd458593          	addi	a1,a1,-1068 # 6218 <lock_release+0x410>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     664:	ba850513          	addi	a0,a0,-1112 # 6208 <lock_release+0x400>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     690:	b7c50513          	addi	a0,a0,-1156 # 6208 <lock_release+0x400>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     6a4:	b6850513          	addi	a0,a0,-1176 # 6208 <lock_release+0x400>
  ...
  write(fd1, "abcdef", 6);
     ...
     6e2:	d6258593          	addi	a1,a1,-670 # 6440 <lock_release+0x638>
     6e6:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     724:	ae850513          	addi	a0,a0,-1304 # 6208 <lock_release+0x400>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     768:	c7c50513          	addi	a0,a0,-900 # 63e0 <lock_release+0x5d8>
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     784:	c8050513          	addi	a0,a0,-896 # 6400 <lock_release+0x5f8>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     798:	c7c50513          	addi	a0,a0,-900 # 6410 <lock_release+0x608>
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     7b4:	c8050513          	addi	a0,a0,-896 # 6430 <lock_release+0x628>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     7c8:	c4c50513          	addi	a0,a0,-948 # 6410 <lock_release+0x608>
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     7e6:	c6650513          	addi	a0,a0,-922 # 6448 <lock_release+0x640>
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     804:	c6850513          	addi	a0,a0,-920 # 6468 <lock_release+0x660>
...
000000000000081a <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     838:	c5450513          	addi	a0,a0,-940 # 6488 <lock_release+0x680>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     850:	c6498993          	addi	s3,s3,-924 # 64b0 <lock_release+0x6a8>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     854:	00006a97          	auipc	s5,0x6
     858:	c94a8a93          	addi	s5,s5,-876 # 64e8 <lock_release+0x6e0>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     89e:	bee50513          	addi	a0,a0,-1042 # 6488 <lock_release+0x680>
  ...
  i = read(fd, buf, N*SZ*2);
     ...
     8b8:	59458593          	addi	a1,a1,1428 # be48 <buf>
  ...
  if(unlink("small") < 0){
     ...
     8da:	bb250513          	addi	a0,a0,-1102 # 6488 <lock_release+0x680>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     904:	b9050513          	addi	a0,a0,-1136 # 6490 <lock_release+0x688>
    ...
    exit(1);
     ...
     922:	ba250513          	addi	a0,a0,-1118 # 64c0 <lock_release+0x6b8>
     ...
     940:	bbc50513          	addi	a0,a0,-1092 # 64f8 <lock_release+0x6f0>
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     95c:	bc850513          	addi	a0,a0,-1080 # 6520 <lock_release+0x718>
    ...
    printf("%s: read failed\n", s);
     ...
     978:	bcc50513          	addi	a0,a0,-1076 # 6540 <lock_release+0x738>
    ...
    printf("%s: unlink small failed\n", s);
     ...
     994:	bc850513          	addi	a0,a0,-1080 # 6558 <lock_release+0x750>
...
00000000000009aa <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9c6:	bb650513          	addi	a0,a0,-1098 # 6578 <lock_release+0x770>
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    ((int*)buf)[0] = i;
     ...
     9da:	47290913          	addi	s2,s2,1138 # be48 <buf>
  for(i = 0; i < MAXFILE; i++){
  ...
  fd = open("big", O_RDONLY);
     ...
     a18:	b6450513          	addi	a0,a0,-1180 # 6578 <lock_release+0x770>
  ...
  n = 0;
    ...
    i = read(fd, buf, BSIZE);
     ...
     a2c:	42090913          	addi	s2,s2,1056 # be48 <buf>
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a60:	b2450513          	addi	a0,a0,-1244 # 6580 <lock_release+0x778>
    ...
    exit(1);
     ...
     a7e:	b2650513          	addi	a0,a0,-1242 # 65a0 <lock_release+0x798>
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     a9a:	b3250513          	addi	a0,a0,-1230 # 65c8 <lock_release+0x7c0>
  ...
  if(unlink("big") < 0){
     ...
     ac6:	ab650513          	addi	a0,a0,-1354 # 6578 <lock_release+0x770>
     ...
     af2:	afa50513          	addi	a0,a0,-1286 # 65e8 <lock_release+0x7e0>
     ...
     b10:	b0450513          	addi	a0,a0,-1276 # 6610 <lock_release+0x808>
     ...
     b2e:	afe50513          	addi	a0,a0,-1282 # 6628 <lock_release+0x820>
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b4a:	b0a50513          	addi	a0,a0,-1270 # 6650 <lock_release+0x848>
...
0000000000000b60 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b78:	41450513          	addi	a0,a0,1044 # 5f88 <lock_release+0x180>
  ...
  write(fd, "hello", SZ);
     ...
     b90:	afc58593          	addi	a1,a1,-1284 # 6688 <lock_release+0x880>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     bac:	3e050513          	addi	a0,a0,992 # 5f88 <lock_release+0x180>
  ...
  if(unlink("unlinkread") != 0){
     ...
     bc2:	3ca50513          	addi	a0,a0,970 # 5f88 <lock_release+0x180>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     bd8:	3b450513          	addi	a0,a0,948 # 5f88 <lock_release+0x180>
  ...
  write(fd1, "yyy", 3);
     ...
     bec:	ae858593          	addi	a1,a1,-1304 # 66d0 <lock_release+0x8c8>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     c08:	24458593          	addi	a1,a1,580 # be48 <buf>
     c0c:	8526                	mv	a0,s1
  ...
  unlink("unlinkread");
     ...
     c54:	33850513          	addi	a0,a0,824 # 5f88 <lock_release+0x180>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c74:	9f850513          	addi	a0,a0,-1544 # 6668 <lock_release+0x860>
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c90:	a0450513          	addi	a0,a0,-1532 # 6690 <lock_release+0x888>
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     cac:	a0850513          	addi	a0,a0,-1528 # 66b0 <lock_release+0x8a8>
    ...
    printf("%s: unlinkread read failed", s);
     ...
     cc8:	a1450513          	addi	a0,a0,-1516 # 66d8 <lock_release+0x8d0>
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ce4:	a1850513          	addi	a0,a0,-1512 # 66f8 <lock_release+0x8f0>
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     d00:	a1c50513          	addi	a0,a0,-1508 # 6718 <lock_release+0x910>
...
0000000000000d16 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     d64:	92858593          	addi	a1,a1,-1752 # 6688 <lock_release+0x880>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     d84:	9c058593          	addi	a1,a1,-1600 # 6740 <lock_release+0x938>
     d88:	00006517          	auipc	a0,0x6
     d8c:	9b050513          	addi	a0,a0,-1616 # 6738 <lock_release+0x930>
  ...
  unlink("lf1");
     ...
     da0:	99c50513          	addi	a0,a0,-1636 # 6738 <lock_release+0x930>
     da4:	00005097          	auipc	ra,0x5
     da8:	afe080e7          	jalr	-1282(ra) # 58a2 <unlink>
  if(open("lf1", 0) >= 0){
     dac:	4581                	li	a1,0
     dae:	00006517          	auipc	a0,0x6
     db2:	98a50513          	addi	a0,a0,-1654 # 6738 <lock_release+0x930>
  ...
  fd = open("lf2", 0);
     ...
     dc8:	97c50513          	addi	a0,a0,-1668 # 6740 <lock_release+0x938>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     de0:	06c58593          	addi	a1,a1,108 # be48 <buf>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     e00:	94458593          	addi	a1,a1,-1724 # 6740 <lock_release+0x938>
     e04:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     e16:	92e50513          	addi	a0,a0,-1746 # 6740 <lock_release+0x938>
     e1a:	00005097          	auipc	ra,0x5
     e1e:	a88080e7          	jalr	-1400(ra) # 58a2 <unlink>
  if(link("lf2", "lf1") >= 0){
     e22:	00006597          	auipc	a1,0x6
     e26:	91658593          	addi	a1,a1,-1770 # 6738 <lock_release+0x930>
     e2a:	00006517          	auipc	a0,0x6
     e2e:	91650513          	addi	a0,a0,-1770 # 6740 <lock_release+0x938>
  ...
  if(link(".", "lf1") >= 0){
     ...
     e42:	8fa58593          	addi	a1,a1,-1798 # 6738 <lock_release+0x930>
     e46:	00006517          	auipc	a0,0x6
     e4a:	a0250513          	addi	a0,a0,-1534 # 6848 <lock_release+0xa40>
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     e6c:	8e050513          	addi	a0,a0,-1824 # 6748 <lock_release+0x940>
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     e88:	8dc50513          	addi	a0,a0,-1828 # 6760 <lock_release+0x958>
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     ea4:	8d850513          	addi	a0,a0,-1832 # 6778 <lock_release+0x970>
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     ec0:	8dc50513          	addi	a0,a0,-1828 # 6798 <lock_release+0x990>
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     edc:	8f050513          	addi	a0,a0,-1808 # 67c8 <lock_release+0x9c0>
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     ef8:	8ec50513          	addi	a0,a0,-1812 # 67e0 <lock_release+0x9d8>
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     f14:	8e850513          	addi	a0,a0,-1816 # 67f8 <lock_release+0x9f0>
    ...
    printf("%s: link non-existent succeeded! oops\n", s);
     ...
     f30:	8f450513          	addi	a0,a0,-1804 # 6820 <lock_release+0xa18>
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     f4c:	90850513          	addi	a0,a0,-1784 # 6850 <lock_release+0xa48>
...
0000000000000f62 <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     fb2:	8c2a0a13          	addi	s4,s4,-1854 # 6870 <lock_release+0xa68>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1004:	87050513          	addi	a0,a0,-1936 # 6870 <lock_release+0xa68>
  ...
  for(i = 0; i < N; i++){
    ...
    1074:	80850513          	addi	a0,a0,-2040 # 6878 <lock_release+0xa70>
    ...
    1094:	80850513          	addi	a0,a0,-2040 # 6898 <lock_release+0xa90>
    ...
    10b0:	80c50513          	addi	a0,a0,-2036 # 68b8 <lock_release+0xab0>
...
00000000000010c6 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    10e2:	7fa98993          	addi	s3,s3,2042 # 68d8 <lock_release+0xad0>
    10e6:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    111e:	7ce50513          	addi	a0,a0,1998 # 68e8 <lock_release+0xae0>
...
pgbug(char *s)
{
  ...
  exec((char*)0xeaeb0b5b00002f5e, argv);
    ...
    1146:	4de4b483          	ld	s1,1246(s1) # 8620 <__SDATA_BEGIN__>
...
badarg(char *s)
{
    ...
    117c:	35048493          	addi	s1,s1,848 # c350 <buf+0x508>
  for(int i = 0; i < 50000; i++){
    ...
    118a:	02a98993          	addi	s3,s3,42 # 61b0 <lock_release+0x3a8>
    argv[0] = (char*)0xffffffff;
...
00000000000011b2 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    1214:	8c078793          	addi	a5,a5,-1856 # 7ad0 <lock_release+0x1cc8>
  ...
  if(pid == 0){
    ...
    124a:	4ea78793          	addi	a5,a5,1258 # 8730 <big.1291>
    124e:	00008697          	auipc	a3,0x8
    1252:	4e268693          	addi	a3,a3,1250 # 9730 <__global_pointer$+0x910>
      big[i] = 'x';
    ...
    1268:	4c078623          	sb	zero,1228(a5) # 9730 <__global_pointer$+0x910>
    char *args2[] = { big, big, big, 0 };
    126c:	00007797          	auipc	a5,0x7
    1270:	f7478793          	addi	a5,a5,-140 # 81e0 <lock_release+0x23d8>
    ...
    1294:	f2050513          	addi	a0,a0,-224 # 61b0 <lock_release+0x3a8>
    ...
    12ac:	6e850513          	addi	a0,a0,1768 # 6990 <lock_release+0xb88>
    ...
    12cc:	64050513          	addi	a0,a0,1600 # 6908 <lock_release+0xb00>
    ...
    12ec:	64050513          	addi	a0,a0,1600 # 6928 <lock_release+0xb20>
    ...
    130e:	63e50513          	addi	a0,a0,1598 # 6948 <lock_release+0xb40>
    ...
    132e:	64650513          	addi	a0,a0,1606 # 6970 <lock_release+0xb68>
    ...
    1348:	ac450513          	addi	a0,a0,-1340 # 6e08 <lock_release+0x1000>
  ...
  if(st != 747){
    ...
    1392:	62a50513          	addi	a0,a0,1578 # 69b8 <lock_release+0xbb0>
...
00000000000013a8 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    13c4:	e4850513          	addi	a0,a0,-440 # 6208 <lock_release+0x400>
  ...
  if(pid == 0){
    ...
    13ee:	e1ea0a13          	addi	s4,s4,-482 # 6208 <lock_release+0x400>
      int n = write(fd, "1234567890", 10);
    13f2:	00005a97          	auipc	s5,0x5
    13f6:	626a8a93          	addi	s5,s5,1574 # 6a18 <lock_release+0xc10>
      int fd = open("truncfile", O_WRONLY);
    13fa:	4585                	li	a1,1
    13fc:	8552                	mv	a0,s4
    ...
    1466:	58650513          	addi	a0,a0,1414 # 69e8 <lock_release+0xbe0>
    ...
    1482:	58250513          	addi	a0,a0,1410 # 6a00 <lock_release+0xbf8>
    ...
    14a0:	58c50513          	addi	a0,a0,1420 # 6a28 <lock_release+0xc20>
    ...
    14be:	d4ea0a13          	addi	s4,s4,-690 # 6208 <lock_release+0x400>
    int n = write(fd, "xxx", 3);
    14c2:	00005a97          	auipc	s5,0x5
    14c6:	586a8a93          	addi	s5,s5,1414 # 6a48 <lock_release+0xc40>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    1510:	cfc50513          	addi	a0,a0,-772 # 6208 <lock_release+0x400>
  ...
  exit(xstatus);
    ...
    152e:	4d650513          	addi	a0,a0,1238 # 6a00 <lock_release+0xbf8>
    ...
    154c:	50850513          	addi	a0,a0,1288 # 6a50 <lock_release+0xc48>
...
0000000000001562 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1574:	c4078793          	addi	a5,a5,-960 # 61b0 <lock_release+0x3a8>
    1578:	fcf43023          	sd	a5,-64(s0)
    157c:	00005797          	auipc	a5,0x5
    1580:	4f478793          	addi	a5,a5,1268 # 6a70 <lock_release+0xc68>
    1584:	fcf43423          	sd	a5,-56(s0)
    1588:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    158c:	00005517          	auipc	a0,0x5
    1590:	4ec50513          	addi	a0,a0,1260 # 6a78 <lock_release+0xc70>
  ...
  if(pid == 0) {
    ...
    15be:	4be50513          	addi	a0,a0,1214 # 6a78 <lock_release+0xc70>
    ...
    15da:	4c250513          	addi	a0,a0,1218 # 6a98 <lock_release+0xc90>
    ...
    15f6:	3f650513          	addi	a0,a0,1014 # 69e8 <lock_release+0xbe0>
    ...
    1612:	47250513          	addi	a0,a0,1138 # 6a80 <lock_release+0xc78>
    ...
    1630:	b8450513          	addi	a0,a0,-1148 # 61b0 <lock_release+0x3a8>
  ...
  if(xstatus != 0)
    ...
    1664:	44850513          	addi	a0,a0,1096 # 6aa8 <lock_release+0xca0>
    ...
    1680:	44450513          	addi	a0,a0,1092 # 6ac0 <lock_release+0xcb8>
  ...
  fd = open("echo-ok", O_RDONLY);
    ...
    1694:	3e850513          	addi	a0,a0,1000 # 6a78 <lock_release+0xc70>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    16be:	e8650513          	addi	a0,a0,-378 # 6540 <lock_release+0x738>
    ...
    16da:	32a50513          	addi	a0,a0,810 # 6a00 <lock_release+0xbf8>
  ...
  unlink("echo-ok");
    ...
    16f4:	38850513          	addi	a0,a0,904 # 6a78 <lock_release+0xc70>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    171e:	3be50513          	addi	a0,a0,958 # 6ad8 <lock_release+0xcd0>
...
000000000000173e <pipe1>:
{
  ...
  if(pid == 0){
    ...
    178a:	6c2a8a93          	addi	s5,s5,1730 # be48 <buf>
      if(cc > sizeof(buf))
    ...
    17a8:	6a470713          	addi	a4,a4,1700 # be48 <buf>
    ...
    17e0:	31450513          	addi	a0,a0,788 # 6af0 <lock_release+0xce8>
    ...
    1806:	646b0b13          	addi	s6,s6,1606 # be48 <buf>
    ...
    181a:	42da8a93          	addi	s5,s5,1069 # 142d <truncate3+0x85>
{
    ...
    1866:	2a650513          	addi	a0,a0,678 # 6b08 <lock_release+0xd00>
    ...
    1882:	2a250513          	addi	a0,a0,674 # 6b20 <lock_release+0xd18>
    ...
    18b4:	28850513          	addi	a0,a0,648 # 6b38 <lock_release+0xd30>
    ...
    18f4:	26850513          	addi	a0,a0,616 # 6b58 <lock_release+0xd50>
...
000000000000190a <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1966:	08650513          	addi	a0,a0,134 # 69e8 <lock_release+0xbe0>
    ...
    1982:	1f250513          	addi	a0,a0,498 # 6b70 <lock_release+0xd68>
    ...
    199e:	1ee50513          	addi	a0,a0,494 # 6b88 <lock_release+0xd80>
...
00000000000019be <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1a16:	fd650513          	addi	a0,a0,-42 # 69e8 <lock_release+0xbe0>
    ...
    1a3a:	fb250513          	addi	a0,a0,-78 # 69e8 <lock_release+0xbe0>
...
0000000000001a58 <forkfork>:
{
    ...
    1ab4:	0f850513          	addi	a0,a0,248 # 6ba8 <lock_release+0xda0>
    ...
    1ac6:	d90080e7          	jalr	-624(ra) # 5852 <exit>
{
    ...
    1b0c:	0b050513          	addi	a0,a0,176 # 6bb8 <lock_release+0xdb0>
...
0000000000001b22 <reparent2>:
{
  ...
  exit(0);
    ...
    1b5a:	2b250513          	addi	a0,a0,690 # 6e08 <lock_release+0x1000>
...
0000000000001b8a <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1bf8:	21450513          	addi	a0,a0,532 # 6e08 <lock_release+0x1000>
    ...
    1c24:	e6050513          	addi	a0,a0,-416 # 6a80 <lock_release+0xc78>
    ...
    1c96:	f4650513          	addi	a0,a0,-186 # 6bd8 <lock_release+0xdd0>
    ...
    1cca:	f2a50513          	addi	a0,a0,-214 # 6bf0 <lock_release+0xde8>
    ...
    1d30:	eec50513          	addi	a0,a0,-276 # 6c18 <lock_release+0xe10>
...
0000000000001db0 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1dd0:	45450513          	addi	a0,a0,1108 # 6220 <lock_release+0x418>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1e0c:	418a8a93          	addi	s5,s5,1048 # 6220 <lock_release+0x418>
      link("cat", "x");
    1e10:	00005b97          	auipc	s7,0x5
    1e14:	e30b8b93          	addi	s7,s7,-464 # 6c40 <lock_release+0xe38>
    1e18:	a091                	j	1e5c <linkunlink+0xac>
    printf("%s: fork failed\n", s);
    1e1a:	85a6                	mv	a1,s1
    1e1c:	00005517          	auipc	a0,0x5
    1e20:	bcc50513          	addi	a0,a0,-1076 # 69e8 <lock_release+0xbe0>
...
0000000000001eb2 <manywrites>:
{
  ...
  exit(0);
    ...
    1f0e:	efe50513          	addi	a0,a0,-258 # 6e08 <lock_release+0x1000>
    ...
    1f4a:	f02b8b93          	addi	s7,s7,-254 # be48 <buf>
    ...
    1fbe:	c8e50513          	addi	a0,a0,-882 # 6c48 <lock_release+0xe40>
    ...
    1fde:	29650513          	addi	a0,a0,662 # 6270 <lock_release+0x468>
...
0000000000001ffc <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    202c:	c5050513          	addi	a0,a0,-944 # 6c78 <lock_release+0xe70>
  ...
  if(wait(0) != -1){
    ...
    208e:	bd650513          	addi	a0,a0,-1066 # 6c60 <lock_release+0xe58>
    ...
    20aa:	bfa50513          	addi	a0,a0,-1030 # 6ca0 <lock_release+0xe98>
    ...
    20c6:	bf650513          	addi	a0,a0,-1034 # 6cb8 <lock_release+0xeb0>
...
00000000000020dc <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    20f8:	35098993          	addi	s3,s3,848 # c350 <buf+0x508>
    20fc:	1003d937          	lui	s2,0x1003d
    2100:	090e                	slli	s2,s2,0x3
    2102:	48090913          	addi	s2,s2,1152 # 1003d480 <__BSS_END__+0x1002e628>
    pid = fork();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2146:	8a650513          	addi	a0,a0,-1882 # 69e8 <lock_release+0xbe0>
    ...
    2168:	b6c50513          	addi	a0,a0,-1172 # 6cd0 <lock_release+0xec8>
...
0000000000002188 <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    21ea:	80250513          	addi	a0,a0,-2046 # 69e8 <lock_release+0xbe0>
    ...
    2216:	ade50513          	addi	a0,a0,-1314 # 6cf0 <lock_release+0xee8>
...
0000000000002236 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    2246:	ac650513          	addi	a0,a0,-1338 # 6d08 <lock_release+0xf00>
  ...
  fd = open("bigarg-ok", 0);
    ...
    2278:	a9450513          	addi	a0,a0,-1388 # 6d08 <lock_release+0xf00>
  ...
  close(fd);
    ...
    229e:	39678793          	addi	a5,a5,918 # 8630 <args.1880>
    22a2:	00006697          	auipc	a3,0x6
    22a6:	48668693          	addi	a3,a3,1158 # 8728 <args.1880+0xf8>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    22aa:	00005717          	auipc	a4,0x5
    22ae:	a6e70713          	addi	a4,a4,-1426 # 6d18 <lock_release+0xf10>
    ...
    2302:	afa50513          	addi	a0,a0,-1286 # 6df8 <lock_release+0xff0>
    ...
    2326:	af650513          	addi	a0,a0,-1290 # 6e18 <lock_release+0x1010>
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    237a:	0007c603          	lbu	a2,0(a5) # fffffffffffff000 <__BSS_END__+0xffffffffffff01a8>
    237e:	85a6                	mv	a1,s1
    2380:	00005517          	auipc	a0,0x5
    2384:	ab850513          	addi	a0,a0,-1352 # 6e38 <lock_release+0x1030>
    ...
    23a0:	64c50513          	addi	a0,a0,1612 # 69e8 <lock_release+0xbe0>
...
00000000000023c0 <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    243a:	69a78793          	addi	a5,a5,1690 # 7ad0 <lock_release+0x1cc8>
  ...
  if(ret != -1){
    ...
    247c:	9e850513          	addi	a0,a0,-1560 # 6e60 <lock_release+0x1058>
    ...
    249a:	47250513          	addi	a0,a0,1138 # 6908 <lock_release+0xb00>
    ...
    24b8:	47450513          	addi	a0,a0,1140 # 6928 <lock_release+0xb20>
    ...
    24d8:	47450513          	addi	a0,a0,1140 # 6948 <lock_release+0xb40>
    ...
    24f6:	47e50513          	addi	a0,a0,1150 # 6970 <lock_release+0xb68>
...
000000000000250c <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    2542:	96250513          	addi	a0,a0,-1694 # 5ea0 <lock_release+0x98>
  ...
  if(n >= 0){
    ...
    2574:	94850513          	addi	a0,a0,-1720 # 6eb8 <lock_release+0x10b0>
    ...
    258e:	8de50513          	addi	a0,a0,-1826 # 6e68 <lock_release+0x1060>
    ...
    25a8:	8dc50513          	addi	a0,a0,-1828 # 6e80 <lock_release+0x1078>
    ...
    25c2:	8e250513          	addi	a0,a0,-1822 # 6ea0 <lock_release+0x1098>
  ...
  unlink("rwsbrk");
    ...
    25e6:	8be50513          	addi	a0,a0,-1858 # 5ea0 <lock_release+0x98>
    25ea:	00003097          	auipc	ra,0x3
    25ee:	2b8080e7          	jalr	696(ra) # 58a2 <unlink>
  fd = open("README", O_RDONLY);
    25f2:	4581                	li	a1,0
    25f4:	00004517          	auipc	a0,0x4
    25f8:	d5450513          	addi	a0,a0,-684 # 6348 <lock_release+0x540>
  ...
  if(n >= 0){
    ...
    2622:	8ca50513          	addi	a0,a0,-1846 # 6ee8 <lock_release+0x10e0>
    ...
    263c:	86850513          	addi	a0,a0,-1944 # 6ea0 <lock_release+0x1098>
...
0000000000002666 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    26a4:	6705                	lui	a4,0x1
      *b = 99;
    26a6:	00d50023          	sb	a3,0(a0) # 40000000 <__BSS_END__+0x3fff11a8>
    for(b = a; b < a+TOOMUCH; b += 4096){
    ...
    26be:	85650513          	addi	a0,a0,-1962 # 6f10 <lock_release+0x1108>
  ...
  for(i = 0; i < 5000; i++){
    ...
    2712:	82250513          	addi	a0,a0,-2014 # 6f30 <lock_release+0x1128>
  ...
  if(c != a + 1){
    ...
    2774:	82050513          	addi	a0,a0,-2016 # 6f90 <lock_release+0x1188>
    ...
    2796:	7be50513          	addi	a0,a0,1982 # 6f50 <lock_release+0x1148>
    ...
    27b2:	7c250513          	addi	a0,a0,1986 # 6f70 <lock_release+0x1168>
...
00000000000027ee <sbrkmuch>:
{
  ...
  *lastaddr = 99;
    ...
    2850:	fee78fa3          	sb	a4,-1(a5) # 63fffff <__BSS_END__+0x63f11a7>
  a = sbrk(0);
    2854:	4501                	li	a0,0
  ...
  if(*lastaddr == 99){
    ...
    28b4:	fff7c703          	lbu	a4,-1(a5) # 63fffff <__BSS_END__+0x63f11a7>
  ...
  if(c != a){
    ...
    28fc:	6b850513          	addi	a0,a0,1720 # 6fb0 <lock_release+0x11a8>
    ...
    2918:	6e450513          	addi	a0,a0,1764 # 6ff8 <lock_release+0x11f0>
    ...
    2938:	6e450513          	addi	a0,a0,1764 # 7018 <lock_release+0x1210>
    ...
    2958:	70450513          	addi	a0,a0,1796 # 7058 <lock_release+0x1250>
    ...
    2974:	71850513          	addi	a0,a0,1816 # 7088 <lock_release+0x1280>
    ...
    2994:	73050513          	addi	a0,a0,1840 # 70c0 <lock_release+0x12b8>
...
00000000000029aa <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    29ce:	71e50513          	addi	a0,a0,1822 # 70e8 <lock_release+0x12e0>
    29d2:	00003097          	auipc	ra,0x3
    29d6:	ec0080e7          	jalr	-320(ra) # 5892 <open>
    29da:	84aa                	mv	s1,a0
  unlink("sbrk");
    29dc:	00004517          	auipc	a0,0x4
    29e0:	70c50513          	addi	a0,a0,1804 # 70e8 <lock_release+0x12e0>
  ...
  if(pipe((int *) a) != 0){
    ...
    2a34:	6c050513          	addi	a0,a0,1728 # 70f0 <lock_release+0x12e8>
    ...
    2a50:	6bc50513          	addi	a0,a0,1724 # 7108 <lock_release+0x1300>
    ...
    2a6c:	08850513          	addi	a0,a0,136 # 6af0 <lock_release+0xce8>
...
0000000000002a82 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2a96:	68e50513          	addi	a0,a0,1678 # 7120 <lock_release+0x1318>
  ...
  close(fd);
    ...
    2ade:	f2650513          	addi	a0,a0,-218 # 6a00 <lock_release+0xbf8>
...
0000000000002af4 <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2b2c:	2e050513          	addi	a0,a0,736 # 6e08 <lock_release+0x1000>
  ...
  if(pid == 0){
    ...
    2b82:	28a50513          	addi	a0,a0,650 # 6e08 <lock_release+0x1000>
  ...
  if(pid == 0){
    ...
    2be2:	22a50513          	addi	a0,a0,554 # 6e08 <lock_release+0x1000>
...
0000000000002cde <sbrk8000>:
{
  ...
  *(top-1) = *(top-1) + 1;
    2cfe:	fff54783          	lbu	a5,-1(a0) # ffffffff7fffffff <__BSS_END__+0xffffffff7fff11a7>
...
execout(char *s)
{
  ...
  exit(0);
    ...
    2d56:	0b650513          	addi	a0,a0,182 # 6e08 <lock_release+0x1000>
    ...
    2daa:	40a50513          	addi	a0,a0,1034 # 61b0 <lock_release+0x3a8>
    2dae:	faa43c23          	sd	a0,-72(s0)
    2db2:	00003797          	auipc	a5,0x3
    2db6:	46e78793          	addi	a5,a5,1134 # 6220 <lock_release+0x418>
...
0000000000002dd8 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    2de8:	51450513          	addi	a0,a0,1300 # 72f8 <lock_release+0x14f0>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    2dfa:	35a50513          	addi	a0,a0,858 # 7150 <lock_release+0x1348>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2e10:	39c50513          	addi	a0,a0,924 # 71a8 <lock_release+0x13a0>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2e2e:	3f650513          	addi	a0,a0,1014 # 7220 <lock_release+0x1418>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    2e4a:	44a50513          	addi	a0,a0,1098 # 7290 <lock_release+0x1488>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2e5c:	49050513          	addi	a0,a0,1168 # 72e8 <lock_release+0x14e0>
  ...
  unlink("12345678901234");
    ...
    2eda:	25250513          	addi	a0,a0,594 # 7128 <lock_release+0x1320>
    ...
    2ef6:	27e50513          	addi	a0,a0,638 # 7170 <lock_release+0x1368>
    ...
    2f12:	2ca50513          	addi	a0,a0,714 # 71d8 <lock_release+0x13d0>
    ...
    2f2e:	32650513          	addi	a0,a0,806 # 7250 <lock_release+0x1448>
    ...
    2f4a:	36a50513          	addi	a0,a0,874 # 72b0 <lock_release+0x14a8>
    ...
    2f66:	3a650513          	addi	a0,a0,934 # 7308 <lock_release+0x1500>
...
0000000000002f7c <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    2f8c:	3b850513          	addi	a0,a0,952 # 7340 <lock_release+0x1538>
  ...
  if(chdir("iputdir") < 0){
    ...
    2fa0:	3a450513          	addi	a0,a0,932 # 7340 <lock_release+0x1538>
  ...
  if(unlink("../iputdir") < 0){
    ...
    2fb4:	3d050513          	addi	a0,a0,976 # 7380 <lock_release+0x1578>
  ...
  if(chdir("/") < 0){
    ...
    2fc8:	3ec50513          	addi	a0,a0,1004 # 73b0 <lock_release+0x15a8>
    ...
    2fe8:	36450513          	addi	a0,a0,868 # 7348 <lock_release+0x1540>
    ...
    3004:	36050513          	addi	a0,a0,864 # 7360 <lock_release+0x1558>
    ...
    3020:	37450513          	addi	a0,a0,884 # 7390 <lock_release+0x1588>
    ...
    303c:	38050513          	addi	a0,a0,896 # 73b8 <lock_release+0x15b0>
...
0000000000003052 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    3070:	2d450513          	addi	a0,a0,724 # 7340 <lock_release+0x1538>
    ...
    3084:	2c050513          	addi	a0,a0,704 # 7340 <lock_release+0x1538>
    ...
    3098:	2ec50513          	addi	a0,a0,748 # 7380 <lock_release+0x1578>
    ...
    30b8:	93450513          	addi	a0,a0,-1740 # 69e8 <lock_release+0xbe0>
    ...
    30d4:	27850513          	addi	a0,a0,632 # 7348 <lock_release+0x1540>
    ...
    30f0:	2e450513          	addi	a0,a0,740 # 73d0 <lock_release+0x15c8>
    ...
    310c:	28850513          	addi	a0,a0,648 # 7390 <lock_release+0x1588>
...
000000000000313a <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    314a:	2a250513          	addi	a0,a0,674 # 73e8 <lock_release+0x15e0>
  ...
  if(chdir("dir0") < 0){
    ...
    315e:	28e50513          	addi	a0,a0,654 # 73e8 <lock_release+0x15e0>
  ...
  if(chdir("..") < 0){
    ...
    3172:	29a50513          	addi	a0,a0,666 # 7408 <lock_release+0x1600>
  ...
  if(unlink("dir0") < 0){
    ...
    3186:	26650513          	addi	a0,a0,614 # 73e8 <lock_release+0x15e0>
    ...
    31a6:	1a650513          	addi	a0,a0,422 # 7348 <lock_release+0x1540>
    ...
    31c2:	23250513          	addi	a0,a0,562 # 73f0 <lock_release+0x15e8>
    ...
    31de:	23650513          	addi	a0,a0,566 # 7410 <lock_release+0x1608>
    ...
    31fa:	23250513          	addi	a0,a0,562 # 7428 <lock_release+0x1620>
...
0000000000003210 <subdir>:
{
  ...
  unlink("ff");
    ...
    3222:	35250513          	addi	a0,a0,850 # 7570 <lock_release+0x1768>
    3226:	00002097          	auipc	ra,0x2
    322a:	67c080e7          	jalr	1660(ra) # 58a2 <unlink>
  if(mkdir("dd") != 0){
    322e:	00004517          	auipc	a0,0x4
    3232:	21250513          	addi	a0,a0,530 # 7440 <lock_release+0x1638>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    324a:	21a50513          	addi	a0,a0,538 # 7460 <lock_release+0x1658>
  ...
  write(fd, "ff", 2);
    ...
    3262:	31258593          	addi	a1,a1,786 # 7570 <lock_release+0x1768>
  ...
  if(unlink("dd") >= 0){
    ...
    327c:	1c850513          	addi	a0,a0,456 # 7440 <lock_release+0x1638>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    3290:	22c50513          	addi	a0,a0,556 # 74b8 <lock_release+0x16b0>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    32a8:	23c50513          	addi	a0,a0,572 # 74e0 <lock_release+0x16d8>
  ...
  write(fd, "FF", 2);
    ...
    32c0:	25458593          	addi	a1,a1,596 # 7510 <lock_release+0x1708>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    32dc:	24050513          	addi	a0,a0,576 # 7518 <lock_release+0x1710>
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    32f4:	b5858593          	addi	a1,a1,-1192 # be48 <buf>
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    330a:	b4274703          	lbu	a4,-1214(a4) # be48 <buf>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    3324:	24858593          	addi	a1,a1,584 # 7568 <lock_release+0x1760>
    3328:	00004517          	auipc	a0,0x4
    332c:	1b850513          	addi	a0,a0,440 # 74e0 <lock_release+0x16d8>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    3340:	1a450513          	addi	a0,a0,420 # 74e0 <lock_release+0x16d8>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    3356:	18e50513          	addi	a0,a0,398 # 74e0 <lock_release+0x16d8>
  ...
  if(chdir("dd") != 0){
    ...
    336a:	0da50513          	addi	a0,a0,218 # 7440 <lock_release+0x1638>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    337e:	28650513          	addi	a0,a0,646 # 7600 <lock_release+0x17f8>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    3392:	2a250513          	addi	a0,a0,674 # 7630 <lock_release+0x1828>
  ...
  if(chdir("./..") != 0){
    ...
    33a6:	2be50513          	addi	a0,a0,702 # 7660 <lock_release+0x1858>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    33bc:	1b050513          	addi	a0,a0,432 # 7568 <lock_release+0x1760>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    33d4:	a7858593          	addi	a1,a1,-1416 # be48 <buf>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    33f6:	0ee50513          	addi	a0,a0,238 # 74e0 <lock_release+0x16d8>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    340e:	2e650513          	addi	a0,a0,742 # 76f0 <lock_release+0x18e8>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3426:	2fe50513          	addi	a0,a0,766 # 7720 <lock_release+0x1918>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    343e:	00650513          	addi	a0,a0,6 # 7440 <lock_release+0x1638>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    3454:	ff050513          	addi	a0,a0,-16 # 7440 <lock_release+0x1638>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    346a:	fda50513          	addi	a0,a0,-38 # 7440 <lock_release+0x1638>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    347e:	33658593          	addi	a1,a1,822 # 77b0 <lock_release+0x19a8>
    3482:	00004517          	auipc	a0,0x4
    3486:	26e50513          	addi	a0,a0,622 # 76f0 <lock_release+0x18e8>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    349a:	31a58593          	addi	a1,a1,794 # 77b0 <lock_release+0x19a8>
    349e:	00004517          	auipc	a0,0x4
    34a2:	28250513          	addi	a0,a0,642 # 7720 <lock_release+0x1918>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    34b6:	0b658593          	addi	a1,a1,182 # 7568 <lock_release+0x1760>
    34ba:	00004517          	auipc	a0,0x4
    34be:	fa650513          	addi	a0,a0,-90 # 7460 <lock_release+0x1658>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    34d2:	22250513          	addi	a0,a0,546 # 76f0 <lock_release+0x18e8>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    34e6:	23e50513          	addi	a0,a0,574 # 7720 <lock_release+0x1918>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    34fa:	07250513          	addi	a0,a0,114 # 7568 <lock_release+0x1760>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    350e:	21650513          	addi	a0,a0,534 # 7720 <lock_release+0x1918>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    3522:	1d250513          	addi	a0,a0,466 # 76f0 <lock_release+0x18e8>
  ...
  if(chdir("dd/ff") == 0){
    ...
    3536:	f2e50513          	addi	a0,a0,-210 # 7460 <lock_release+0x1658>
  ...
  if(chdir("dd/xx") == 0){
    ...
    354a:	3ba50513          	addi	a0,a0,954 # 7900 <lock_release+0x1af8>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    355e:	00e50513          	addi	a0,a0,14 # 7568 <lock_release+0x1760>
  ...
  if(unlink("dd/ff") != 0){
    ...
    3572:	ef250513          	addi	a0,a0,-270 # 7460 <lock_release+0x1658>
  ...
  if(unlink("dd") == 0){
    ...
    3586:	ebe50513          	addi	a0,a0,-322 # 7440 <lock_release+0x1638>
  ...
  if(unlink("dd/dd") < 0){
    ...
    359a:	3da50513          	addi	a0,a0,986 # 7970 <lock_release+0x1b68>
  ...
  if(unlink("dd") < 0){
    ...
    35ae:	e9650513          	addi	a0,a0,-362 # 7440 <lock_release+0x1638>
    ...
    35d0:	e7c50513          	addi	a0,a0,-388 # 7448 <lock_release+0x1640>
    ...
    35ec:	e8050513          	addi	a0,a0,-384 # 7468 <lock_release+0x1660>
    ...
    3608:	e8450513          	addi	a0,a0,-380 # 7488 <lock_release+0x1680>
    ...
    3624:	ea050513          	addi	a0,a0,-352 # 74c0 <lock_release+0x16b8>
    ...
    3640:	eb450513          	addi	a0,a0,-332 # 74f0 <lock_release+0x16e8>
    ...
    365c:	ed050513          	addi	a0,a0,-304 # 7528 <lock_release+0x1720>
    ...
    3678:	ed450513          	addi	a0,a0,-300 # 7548 <lock_release+0x1740>
    ...
    3694:	ee850513          	addi	a0,a0,-280 # 7578 <lock_release+0x1770>
    ...
    36b0:	ef450513          	addi	a0,a0,-268 # 75a0 <lock_release+0x1798>
    ...
    36cc:	ef850513          	addi	a0,a0,-264 # 75c0 <lock_release+0x17b8>
    ...
    36e8:	f0450513          	addi	a0,a0,-252 # 75e8 <lock_release+0x17e0>
    ...
    3704:	f1050513          	addi	a0,a0,-240 # 7610 <lock_release+0x1808>
    ...
    3720:	f2450513          	addi	a0,a0,-220 # 7640 <lock_release+0x1838>
    ...
    373c:	f3050513          	addi	a0,a0,-208 # 7668 <lock_release+0x1860>
    ...
    3758:	f2c50513          	addi	a0,a0,-212 # 7680 <lock_release+0x1878>
    ...
    3774:	f3050513          	addi	a0,a0,-208 # 76a0 <lock_release+0x1898>
    ...
    3790:	f3450513          	addi	a0,a0,-204 # 76c0 <lock_release+0x18b8>
    ...
    37ac:	f5850513          	addi	a0,a0,-168 # 7700 <lock_release+0x18f8>
    ...
    37c8:	f6c50513          	addi	a0,a0,-148 # 7730 <lock_release+0x1928>
    ...
    37e4:	f7050513          	addi	a0,a0,-144 # 7750 <lock_release+0x1948>
    ...
    3800:	f7450513          	addi	a0,a0,-140 # 7770 <lock_release+0x1968>
    ...
    381c:	f7850513          	addi	a0,a0,-136 # 7790 <lock_release+0x1988>
    ...
    3838:	f8c50513          	addi	a0,a0,-116 # 77c0 <lock_release+0x19b8>
    ...
    3854:	f9850513          	addi	a0,a0,-104 # 77e8 <lock_release+0x19e0>
    ...
    3870:	fa450513          	addi	a0,a0,-92 # 7810 <lock_release+0x1a08>
    ...
    388c:	fb050513          	addi	a0,a0,-80 # 7838 <lock_release+0x1a30>
    ...
    38a8:	fb450513          	addi	a0,a0,-76 # 7858 <lock_release+0x1a50>
    ...
    38c4:	fb850513          	addi	a0,a0,-72 # 7878 <lock_release+0x1a70>
    ...
    38e0:	fc450513          	addi	a0,a0,-60 # 78a0 <lock_release+0x1a98>
    ...
    38fc:	fc850513          	addi	a0,a0,-56 # 78c0 <lock_release+0x1ab8>
    ...
    3918:	fcc50513          	addi	a0,a0,-52 # 78e0 <lock_release+0x1ad8>
    ...
    3934:	fd850513          	addi	a0,a0,-40 # 7908 <lock_release+0x1b00>
    ...
    3950:	c5450513          	addi	a0,a0,-940 # 75a0 <lock_release+0x1798>
    ...
    396c:	fc050513          	addi	a0,a0,-64 # 7928 <lock_release+0x1b20>
    ...
    3988:	fc450513          	addi	a0,a0,-60 # 7948 <lock_release+0x1b40>
    ...
    39a4:	fd850513          	addi	a0,a0,-40 # 7978 <lock_release+0x1b70>
    ...
    39c0:	fdc50513          	addi	a0,a0,-36 # 7998 <lock_release+0x1b90>
...
00000000000039d6 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    39e6:	fce50513          	addi	a0,a0,-50 # 79b0 <lock_release+0x1ba8>
  ...
  if(chdir("dots") != 0){
    ...
    39f8:	fbc50513          	addi	a0,a0,-68 # 79b0 <lock_release+0x1ba8>
  ...
  if(unlink(".") == 0){
    ...
    3a0a:	e4250513          	addi	a0,a0,-446 # 6848 <lock_release+0xa40>
  ...
  if(unlink("..") == 0){
    ...
    3a1c:	9f050513          	addi	a0,a0,-1552 # 7408 <lock_release+0x1600>
  ...
  if(chdir("/") != 0){
    ...
    3a2e:	98650513          	addi	a0,a0,-1658 # 73b0 <lock_release+0x15a8>
  ...
  if(unlink("dots/.") == 0){
    ...
    3a40:	fdc50513          	addi	a0,a0,-36 # 7a18 <lock_release+0x1c10>
  ...
  if(unlink("dots/..") == 0){
    ...
    3a52:	ff250513          	addi	a0,a0,-14 # 7a40 <lock_release+0x1c38>
  ...
  if(unlink("dots") != 0){
    ...
    3a64:	f5050513          	addi	a0,a0,-176 # 79b0 <lock_release+0x1ba8>
    ...
    3a82:	f3a50513          	addi	a0,a0,-198 # 79b8 <lock_release+0x1bb0>
    ...
    3a9e:	f3650513          	addi	a0,a0,-202 # 79d0 <lock_release+0x1bc8>
    ...
    3aba:	f3250513          	addi	a0,a0,-206 # 79e8 <lock_release+0x1be0>
    ...
    3ad6:	f2e50513          	addi	a0,a0,-210 # 7a00 <lock_release+0x1bf8>
    ...
    3af2:	8ca50513          	addi	a0,a0,-1846 # 73b8 <lock_release+0x15b0>
    ...
    3b0e:	f1650513          	addi	a0,a0,-234 # 7a20 <lock_release+0x1c18>
    ...
    3b2a:	f2250513          	addi	a0,a0,-222 # 7a48 <lock_release+0x1c40>
    ...
    3b46:	f2650513          	addi	a0,a0,-218 # 7a68 <lock_release+0x1c60>
...
0000000000003b5c <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3b72:	5e250513          	addi	a0,a0,1506 # 6150 <lock_release+0x348>
  ...
  if(chdir("dirfile") == 0){
    ...
    3b8e:	5c650513          	addi	a0,a0,1478 # 6150 <lock_release+0x348>
  ...
  fd = open("dirfile/xx", 0);
    ...
    3ba2:	f2a50513          	addi	a0,a0,-214 # 7ac8 <lock_release+0x1cc0>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    3bba:	f1250513          	addi	a0,a0,-238 # 7ac8 <lock_release+0x1cc0>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    3bce:	efe50513          	addi	a0,a0,-258 # 7ac8 <lock_release+0x1cc0>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    3be2:	eea50513          	addi	a0,a0,-278 # 7ac8 <lock_release+0x1cc0>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    3bf6:	ed658593          	addi	a1,a1,-298 # 7ac8 <lock_release+0x1cc0>
    3bfa:	00002517          	auipc	a0,0x2
    3bfe:	74e50513          	addi	a0,a0,1870 # 6348 <lock_release+0x540>
  ...
  if(unlink("dirfile") != 0){
    ...
    3c12:	54250513          	addi	a0,a0,1346 # 6150 <lock_release+0x348>
  ...
  fd = open(".", O_RDWR);
    ...
    3c28:	c2450513          	addi	a0,a0,-988 # 6848 <lock_release+0xa40>
  ...
  fd = open(".", 0);
    ...
    3c3e:	c0e50513          	addi	a0,a0,-1010 # 6848 <lock_release+0xa40>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    3c52:	5d258593          	addi	a1,a1,1490 # 6220 <lock_release+0x418>
  ...
  close(fd);
    ...
    3c7e:	e0e50513          	addi	a0,a0,-498 # 7a88 <lock_release+0x1c80>
    ...
    3c9a:	e1250513          	addi	a0,a0,-494 # 7aa8 <lock_release+0x1ca0>
    ...
    3cb6:	e2650513          	addi	a0,a0,-474 # 7ad8 <lock_release+0x1cd0>
    ...
    3cd2:	e0a50513          	addi	a0,a0,-502 # 7ad8 <lock_release+0x1cd0>
    ...
    3cee:	e1650513          	addi	a0,a0,-490 # 7b00 <lock_release+0x1cf8>
    ...
    3d0a:	e2250513          	addi	a0,a0,-478 # 7b28 <lock_release+0x1d20>
    ...
    3d26:	e2e50513          	addi	a0,a0,-466 # 7b50 <lock_release+0x1d48>
    ...
    3d42:	e3a50513          	addi	a0,a0,-454 # 7b78 <lock_release+0x1d70>
    ...
    3d5e:	e3e50513          	addi	a0,a0,-450 # 7b98 <lock_release+0x1d90>
    ...
    3d7a:	e4a50513          	addi	a0,a0,-438 # 7bc0 <lock_release+0x1db8>
...
0000000000003d90 <iref>:
{
    ...
    3dae:	e2ea0a13          	addi	s4,s4,-466 # 7bd8 <lock_release+0x1dd0>
    mkdir("");
    3db2:	00004497          	auipc	s1,0x4
    3db6:	93648493          	addi	s1,s1,-1738 # 76e8 <lock_release+0x18e0>
    link("README", "");
    3dba:	00002a97          	auipc	s5,0x2
    3dbe:	58ea8a93          	addi	s5,s5,1422 # 6348 <lock_release+0x540>
    fd = open("xx", O_CREATE);
    3dc2:	00004997          	auipc	s3,0x4
    3dc6:	d0e98993          	addi	s3,s3,-754 # 7ad0 <lock_release+0x1cc8>
    3dca:	a891                	j	3e1e <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    3dcc:	85da                	mv	a1,s6
    3dce:	00004517          	auipc	a0,0x4
    3dd2:	e1250513          	addi	a0,a0,-494 # 7be0 <lock_release+0x1dd8>
    ...
    3dee:	e0e50513          	addi	a0,a0,-498 # 7bf8 <lock_release+0x1df0>
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    3e82:	58a98993          	addi	s3,s3,1418 # 7408 <lock_release+0x1600>
    unlink("irefd");
    3e86:	00004917          	auipc	s2,0x4
    3e8a:	d5290913          	addi	s2,s2,-686 # 7bd8 <lock_release+0x1dd0>
    chdir("..");
    3e8e:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    3eaa:	50a50513          	addi	a0,a0,1290 # 73b0 <lock_release+0x15a8>
...
0000000000003eca <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    3eda:	d3a50513          	addi	a0,a0,-710 # 7c10 <lock_release+0x1e08>
  ...
  if(pid == 0){
    ...
    3efe:	d1650513          	addi	a0,a0,-746 # 7c10 <lock_release+0x1e08>
    ...
    3f14:	d2050513          	addi	a0,a0,-736 # 7c30 <lock_release+0x1e28>
    ...
    3f30:	cec50513          	addi	a0,a0,-788 # 7c18 <lock_release+0x1e10>
    ...
    3f4c:	aa050513          	addi	a0,a0,-1376 # 69e8 <lock_release+0xbe0>
  ...
  if(unlink("oidir") != 0){
    ...
    3f7a:	c9a50513          	addi	a0,a0,-870 # 7c10 <lock_release+0x1e08>
    ...
    3f8e:	c4e50513          	addi	a0,a0,-946 # 6bd8 <lock_release+0xdd0>
...
0000000000003fbc <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    3fcc:	c9050513          	addi	a0,a0,-880 # 7c58 <lock_release+0x1e50>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    3ff8:	c6450513          	addi	a0,a0,-924 # 7c58 <lock_release+0x1e50>
  ...
  sleep(10); // one second
    ...
    4030:	b7c50513          	addi	a0,a0,-1156 # 6ba8 <lock_release+0xda0>
    ...
    404a:	c1248493          	addi	s1,s1,-1006 # 7c58 <lock_release+0x1e50>
    404e:	4581                	li	a1,0
    4050:	8526                	mv	a0,s1
...
000000000000408c <killstatus>:
{
  ...
  exit(0);
    ...
    40f2:	8fa50513          	addi	a0,a0,-1798 # 69e8 <lock_release+0xbe0>
    ...
    4118:	b5450513          	addi	a0,a0,-1196 # 7c68 <lock_release+0x1e60>
...
000000000000412e <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    4158:	a5450513          	addi	a0,a0,-1452 # 6ba8 <lock_release+0xda0>
  ...
  if(pid2 == 0)
    ...
    4186:	86650513          	addi	a0,a0,-1946 # 69e8 <lock_release+0xbe0>
  ...
  if(pid3 == 0){
    ...
    41ca:	05a58593          	addi	a1,a1,90 # 6220 <lock_release+0x418>
    ...
    41f4:	7f850513          	addi	a0,a0,2040 # 69e8 <lock_release+0xbe0>
    ...
    4210:	a7c50513          	addi	a0,a0,-1412 # 7c88 <lock_release+0x1e80>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    4230:	c1c58593          	addi	a1,a1,-996 # be48 <buf>
    ...
    424c:	a5850513          	addi	a0,a0,-1448 # 7ca0 <lock_release+0x1e98>
  ...
  printf("kill... ");
    ...
    4278:	a4450513          	addi	a0,a0,-1468 # 7cb8 <lock_release+0x1eb0>
  ...
  printf("wait... ");
    ...
    42a6:	a2650513          	addi	a0,a0,-1498 # 7cc8 <lock_release+0x1ec0>
...
00000000000042d2 <reparent>:
{
  ...
  exit(0);
    ...
    4326:	6c650513          	addi	a0,a0,1734 # 69e8 <lock_release+0xbe0>
    ...
    4342:	83250513          	addi	a0,a0,-1998 # 6b70 <lock_release+0xd68>
...
0000000000004382 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    43b8:	73c50513          	addi	a0,a0,1852 # 6af0 <lock_release+0xce8>
    ...
    43ee:	e3658593          	addi	a1,a1,-458 # 6220 <lock_release+0x418>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    44b2:	82a50513          	addi	a0,a0,-2006 # 7cd8 <lock_release+0x1ed0>
    ...
    44ce:	51e50513          	addi	a0,a0,1310 # 69e8 <lock_release+0xbe0>
    ...
    451a:	7e250513          	addi	a0,a0,2018 # 7cf8 <lock_release+0x1ef0>
...
000000000000453a <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    45a2:	78a50513          	addi	a0,a0,1930 # 7d28 <lock_release+0x1f20>
...
00000000000045e0 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    4676:	6d650513          	addi	a0,a0,1750 # 7d48 <lock_release+0x1f40>
    ...
    4692:	6e250513          	addi	a0,a0,1762 # 7d70 <lock_release+0x1f68>
  ...
  fd = open("sharedfd", 0);
    ...
    46d6:	8ee50513          	addi	a0,a0,-1810 # 5fc0 <lock_release+0x1b8>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4716:	67e50513          	addi	a0,a0,1662 # 7d90 <lock_release+0x1f88>
    ...
    4730:	fd2783e3          	beq	a5,s2,46f6 <sharedfd+0x116>
      if(buf[i] == 'c')
    4734:	0007c703          	lbu	a4,0(a5) # 3e800000 <__BSS_END__+0x3e7f11a8>
  ...
  unlink("sharedfd");
    ...
    4752:	87250513          	addi	a0,a0,-1934 # 5fc0 <lock_release+0x1b8>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    4778:	64450513          	addi	a0,a0,1604 # 7db8 <lock_release+0x1fb0>
...
0000000000004798 <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    47bc:	66078793          	addi	a5,a5,1632 # 5e18 <lock_release+0x10>
    47c0:	f6f43823          	sd	a5,-144(s0)
    47c4:	00001797          	auipc	a5,0x1
    47c8:	65c78793          	addi	a5,a5,1628 # 5e20 <lock_release+0x18>
    47cc:	f6f43c23          	sd	a5,-136(s0)
    47d0:	00001797          	auipc	a5,0x1
    47d4:	65878793          	addi	a5,a5,1624 # 5e28 <lock_release+0x20>
    47d8:	f8f43023          	sd	a5,-128(s0)
    47dc:	00001797          	auipc	a5,0x1
    47e0:	65478793          	addi	a5,a5,1620 # 5e30 <lock_release+0x28>
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    483a:	612a0a13          	addi	s4,s4,1554 # be48 <buf>
    483e:	00007a97          	auipc	s5,0x7
    4842:	60ba8a93          	addi	s5,s5,1547 # be49 <buf+0x1>
    if(total != N*SZ){
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4858:	5b450513          	addi	a0,a0,1460 # 6e08 <lock_release+0x1000>
    ...
    48d2:	50250513          	addi	a0,a0,1282 # 7dd0 <lock_release+0x1fc8>
    ...
    48ec:	4f850513          	addi	a0,a0,1272 # 7de0 <lock_release+0x1fd8>
    ...
    4910:	4ec50513          	addi	a0,a0,1260 # 7df8 <lock_release+0x1ff0>
    ...
    4940:	50c78793          	addi	a5,a5,1292 # be48 <buf>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    49a0:	46c50513          	addi	a0,a0,1132 # 7e08 <lock_release+0x2000>
...
00000000000049d4 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4a02:	422b8b93          	addi	s7,s7,1058 # 7e20 <lock_release+0x2018>
  for(i = 0; i < N; i++){
    ...
    4a44:	3e850513          	addi	a0,a0,1000 # 7e28 <lock_release+0x2020>
    ...
    4a62:	3c250513          	addi	a0,a0,962 # 7e20 <lock_release+0x2018>
  ...
  fd = open(".", 0);
    ...
    4a9a:	db250513          	addi	a0,a0,-590 # 6848 <lock_release+0xa40>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4ac0:	38c50513          	addi	a0,a0,908 # 7e48 <lock_release+0x2040>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4b30:	33c50513          	addi	a0,a0,828 # 7e68 <lock_release+0x2060>
  ...
  for(i = 0; i < N; i++){
    ...
    4b68:	32c50513          	addi	a0,a0,812 # 7e90 <lock_release+0x2088>
    ...
    4b84:	e6850513          	addi	a0,a0,-408 # 69e8 <lock_release+0xbe0>
...
0000000000004d2e <bigfile>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4d6e:	0de90913          	addi	s2,s2,222 # be48 <buf>
  for(i = 0; i < N; i++){
    4d72:	4a51                	li	s4,20
  if(fd < 0){
  ...
  fd = open("bigfile.dat", 0);
    ...
    4db6:	11650513          	addi	a0,a0,278 # 7ec8 <lock_release+0x20c0>
  ...
  for(i = 0; ; i++){
    ...
    4dcc:	08090913          	addi	s2,s2,128 # be48 <buf>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    4e1a:	0c250513          	addi	a0,a0,194 # 7ed8 <lock_release+0x20d0>
    ...
    4e36:	0c650513          	addi	a0,a0,198 # 7ef8 <lock_release+0x20f0>
    ...
    4e52:	0ca50513          	addi	a0,a0,202 # 7f18 <lock_release+0x2110>
    ...
    4e6e:	0ce50513          	addi	a0,a0,206 # 7f38 <lock_release+0x2130>
    ...
    4e8a:	0d250513          	addi	a0,a0,210 # 7f58 <lock_release+0x2150>
    ...
    4ea6:	0ce50513          	addi	a0,a0,206 # 7f70 <lock_release+0x2168>
  ...
  unlink("bigfile.dat");
    ...
    4ed4:	ff850513          	addi	a0,a0,-8 # 7ec8 <lock_release+0x20c0>
    ...
    4ef8:	09c50513          	addi	a0,a0,156 # 7f90 <lock_release+0x2188>
...
0000000000004f0e <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    4f30:	08450513          	addi	a0,a0,132 # 7fb0 <lock_release+0x21a8>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    4f50:	074c8c93          	addi	s9,s9,116 # 7fc0 <lock_release+0x21b8>
    int total = 0;
    4f54:	4d81                	li	s11,0
      int cc = write(fd, buf, BSIZE);
    4f56:	00007a17          	auipc	s4,0x7
    4f5a:	ef2a0a13          	addi	s4,s4,-270 # be48 <buf>
    name[0] = 'f';
    ...
    4fca:	00a50513          	addi	a0,a0,10 # 7fd0 <lock_release+0x21c8>
  ...
  printf("fsfull test finished\n");
    ...
    5040:	fb450513          	addi	a0,a0,-76 # 7ff0 <lock_release+0x21e8>
    ...
    5090:	f5450513          	addi	a0,a0,-172 # 7fe0 <lock_release+0x21d8>
...
00000000000050ae <badwrite>:
{
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    5122:	eea50513          	addi	a0,a0,-278 # 8008 <lock_release+0x2200>
  ...
  if(write(fd, "x", 1) != 1){
    ...
    513a:	0ea58593          	addi	a1,a1,234 # 6220 <lock_release+0x418>
    ...
    5150:	edc50513          	addi	a0,a0,-292 # 8028 <lock_release+0x2220>
    ...
    516a:	eaa50513          	addi	a0,a0,-342 # 8010 <lock_release+0x2208>
    ...
    5184:	e9050513          	addi	a0,a0,-368 # 8010 <lock_release+0x2208>
  ...
  unlink("junk");
    ...
    51a8:	e6450513          	addi	a0,a0,-412 # 8008 <lock_release+0x2200>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    51fe:	02690913          	addi	s2,s2,38 # 6220 <lock_release+0x418>
      uint64 a = (uint64) sbrk(4096);
    ...
    5232:	e4a50513          	addi	a0,a0,-438 # 8078 <lock_release+0x2270>
    ...
    524c:	df050513          	addi	a0,a0,-528 # 8038 <lock_release+0x2230>
    ...
    5266:	df650513          	addi	a0,a0,-522 # 8058 <lock_release+0x2250>
  ...
  while(1){
    ...
    52b4:	de850513          	addi	a0,a0,-536 # 8098 <lock_release+0x2290>
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    5304:	db850513          	addi	a0,a0,-584 # 80b8 <lock_release+0x22b0>
  ...
  if(pid == 0) {
    ...
    5334:	db050513          	addi	a0,a0,-592 # 80e0 <lock_release+0x22d8>
    ...
    5358:	d7450513          	addi	a0,a0,-652 # 80c8 <lock_release+0x22c0>
    ...
    5380:	d6c50513          	addi	a0,a0,-660 # 80e8 <lock_release+0x22e0>
...
main(int argc, char *argv[])
{
  ...
  struct test {
    ...
    53ca:	e3a78793          	addi	a5,a5,-454 # 8200 <lock_release+0x23f8>
    53ce:	bd040713          	addi	a4,s0,-1072
    53d2:	00003317          	auipc	t1,0x3
    53d6:	21e30313          	addi	t1,t1,542 # 85f0 <lock_release+0x27e8>
  ...
  printf("usertests starting\n");
    ...
    540a:	d9a50513          	addi	a0,a0,-614 # 81a0 <lock_release+0x2398>
  ...
  if(fail){
    ...
    5442:	d1a50513          	addi	a0,a0,-742 # 8158 <lock_release+0x2350>
  ...
  if(argc == 2 && strcmp(argv[1], "-c") == 0){
    ...
    545e:	c9658593          	addi	a1,a1,-874 # 80f0 <lock_release+0x22e8>
    ...
    5474:	d6858593          	addi	a1,a1,-664 # 81d8 <lock_release+0x23d0>
    ...
    5498:	c6450513          	addi	a0,a0,-924 # 80f8 <lock_release+0x22f0>
  ...
  if(fail){
    ...
    5504:	c4050513          	addi	a0,a0,-960 # 8140 <lock_release+0x2338>
    ...
    551e:	c6e50513          	addi	a0,a0,-914 # 8188 <lock_release+0x2380>
    ...
    557c:	c8878793          	addi	a5,a5,-888 # 8200 <lock_release+0x23f8>
    5580:	bd040713          	addi	a4,s0,-1072
    5584:	00003317          	auipc	t1,0x3
    5588:	06c30313          	addi	t1,t1,108 # 85f0 <lock_release+0x27e8>
    ...
    55bc:	c0050513          	addi	a0,a0,-1024 # 81b8 <lock_release+0x23b0>
    55c0:	00000097          	auipc	ra,0x0
    55c4:	61a080e7          	jalr	1562(ra) # 5bda <printf>
        printf("SOME TESTS FAILED\n");
    55c8:	00003a97          	auipc	s5,0x3
    55cc:	b78a8a93          	addi	s5,s5,-1160 # 8140 <lock_release+0x2338>
        if(continuous != 2)
    55d0:	4a09                	li	s4,2
        printf("FAILED -- lost %d free pages\n", free0 - free1);
    55d2:	00003b17          	auipc	s6,0x3
    55d6:	b4eb0b13          	addi	s6,s6,-1202 # 8120 <lock_release+0x2318>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    594a:	cb250513          	addi	a0,a0,-846 # 85f8 <digits>
    594e:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    5a16:	be6b8b93          	addi	s7,s7,-1050 # 85f8 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    5b56:	a9e90913          	addi	s2,s2,-1378 # 85f0 <lock_release+0x27e8>
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    5c1e:	a0e7b783          	ld	a5,-1522(a5) # 8628 <freep>
    ...
    5c4c:	00e6ea63          	bltu	a3,a4,5c60 <free+0x50>
{
  ...
  freep = p;
    ...
    5c8e:	98f73f23          	sd	a5,-1634(a4) # 8628 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    5cc0:	96c53503          	ld	a0,-1684(a0) # 8628 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    5ce8:	94490913          	addi	s2,s2,-1724 # 8628 <freep>
  if(p == (char*)-1)
    5cec:	5afd                	li	s5,-1
    5cee:	a88d                	j	5d60 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
    5cf0:	00009797          	auipc	a5,0x9
    5cf4:	15878793          	addi	a5,a5,344 # ee48 <base>
    5cf8:	00003717          	auipc	a4,0x3
    5cfc:	92f73823          	sd	a5,-1744(a4) # 8628 <freep>
    ...
    5d22:	90a73523          	sd	a0,-1782(a4) # 8628 <freep>
      return (void*)(p + 1);
...
0000000000005d7c <thread_create>:
...
{
    5d7c:	1101                	addi	sp,sp,-32
    5d7e:	ec06                	sd	ra,24(sp)
    5d80:	e822                	sd	s0,16(sp)
    5d82:	e426                	sd	s1,8(sp)
    5d84:	e04a                	sd	s2,0(sp)
    5d86:	1000                	addi	s0,sp,32
    5d88:	84aa                	mv	s1,a0
    5d8a:	892e                	mv	s2,a1
	void *stack = malloc(2*4096U);
    5d8c:	6509                	lui	a0,0x2
    5d8e:	00000097          	auipc	ra,0x0
    5d92:	f0a080e7          	jalr	-246(ra) # 5c98 <malloc>
	if((uint64)stack%4096U)
    5d96:	03451793          	slli	a5,a0,0x34
    5d9a:	c791                	beqz	a5,5da6 <thread_create+0x2a>
    5d9c:	0347d713          	srli	a4,a5,0x34
	{
		stack = stack + (4096U - (uint64)stack%4096U);
    5da0:	6785                	lui	a5,0x1
    5da2:	8f99                	sub	a5,a5,a4
    5da4:	953e                	add	a0,a0,a5
	}
	int size = 8;
    ...
    5db0:	b46080e7          	jalr	-1210(ra) # 58f2 <clone>
    5db4:	85aa                	mv	a1,a0
	if(tid<0)
    5db6:	02055163          	bgez	a0,5dd8 <thread_create+0x5c>
	{
		printf("Clone failed\n",tid);
    5dba:	00003517          	auipc	a0,0x3
    5dbe:	85650513          	addi	a0,a0,-1962 # 8610 <digits+0x18>
    5dc2:	00000097          	auipc	ra,0x0
    5dc6:	e18080e7          	jalr	-488(ra) # 5bda <printf>
		return 0;
	}
	texit();
	return 0;
    ...
    5dca:	4501                	li	a0,0
    5dcc:	60e2                	ld	ra,24(sp)
    5dce:	6442                	ld	s0,16(sp)
    5dd0:	64a2                	ld	s1,8(sp)
    5dd2:	6902                	ld	s2,0(sp)
    5dd4:	6105                	addi	sp,sp,32
    5dd6:	8082                	ret
	texit();
    5dd8:	00000097          	auipc	ra,0x0
    5ddc:	b22080e7          	jalr	-1246(ra) # 58fa <texit>

0000000000005de0 <lock_init>:
...
int lock_init(lock_t *lock)
{
	...
	lock->flag = 0;
    5de6:	00053023          	sd	zero,0(a0)
	return 0;
}
    5dea:	4501                	li	a0,0
    5dec:	6422                	ld	s0,8(sp)
    5dee:	0141                	addi	sp,sp,16
    5df0:	8082                	ret

0000000000005df2 <lock_acquire>:
void lock_acquire(lock_t *lock)
{
    ...
    5df8:	4705                	li	a4,1
    5dfa:	87ba                	mv	a5,a4
    5dfc:	0cf537af          	amoswap.d.aq	a5,a5,(a0)
    5e00:	ffed                	bnez	a5,5dfa <lock_acquire+0x8>
            ;
}
    5e02:	6422                	ld	s0,8(sp)
    5e04:	0141                	addi	sp,sp,16
    5e06:	8082                	ret

0000000000005e08 <lock_release>:

void lock_release(lock_t *lock){
    5e08:	1141                	addi	sp,sp,-16
    5e0a:	e422                	sd	s0,8(sp)
    5e0c:	0800                	addi	s0,sp,16
	lock->flag = 0;
    5e0e:	00053023          	sd	zero,0(a0)
}
