...
printint(int fd, int xx, int base, int sgn)
{
 ...
 398:	4dc50513          	addi	a0,a0,1244 # 870 <digits>
 39c:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 464:	410b8b93          	addi	s7,s7,1040 # 870 <digits>
 ...
 5a4:	2c890913          	addi	s2,s2,712 # 868 <lock_release+0x12>
        while(*s != 0){
...
00000000000007ca <thread_create>:
...
void *thread_create(void*(start_routine)(void*),void *arg)
{
 ...
 7e0:	f0a080e7          	jalr	-246(ra) # 6e6 <malloc>
	if((uint64)stack%4096U)
 7e4:	03451793          	slli	a5,a0,0x34
 7e8:	c791                	beqz	a5,7f4 <thread_create+0x2a>
 7ea:	0347d713          	srli	a4,a5,0x34
	{
		stack = stack + (4096U - (uint64)stack%4096U);
 7ee:	6785                	lui	a5,0x1
 7f0:	8f99                	sub	a5,a5,a4
 7f2:	953e                	add	a0,a0,a5
	}
	int size = 8;
 ...
 7fe:	b46080e7          	jalr	-1210(ra) # 340 <clone>
 802:	85aa                	mv	a1,a0
	if(tid<0)
 804:	02055163          	bgez	a0,826 <thread_create+0x5c>
	{
		printf("Clone failed\n",tid);
 808:	00000517          	auipc	a0,0x0
 80c:	08050513          	addi	a0,a0,128 # 888 <digits+0x18>
 810:	00000097          	auipc	ra,0x0
 814:	e18080e7          	jalr	-488(ra) # 628 <printf>
		return 0;
	}
	texit();
	return 0;
 ...
 82a:	b22080e7          	jalr	-1246(ra) # 348 <texit>

000000000000082e <lock_init>:
...
void lock_acquire(lock_t *lock)
{
 ...
 846:	4705                	li	a4,1
 848:	87ba                	mv	a5,a4
 84a:	0cf537af          	amoswap.d.aq	a5,a5,(a0)
 84e:	ffed                	bnez	a5,848 <lock_acquire+0x8>
            ;
}
 850:	6422                	ld	s0,8(sp)
