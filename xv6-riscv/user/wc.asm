...
wc(int fd, char *name)
{
  ...
  3c:	9a0a0a13          	addi	s4,s4,-1632 # 9d8 <lock_release+0x16>
        inword = 0;
  40:	4b01                	li	s6,0
  while((n = read(fd, buf, sizeof(buf))) > 0){
  ...
  ba:	93a50513          	addi	a0,a0,-1734 # 9f0 <lock_release+0x2e>
  ...
  e8:	8fc50513          	addi	a0,a0,-1796 # 9e0 <lock_release+0x1e>
...
main(int argc, char *argv[])
{
 ...
 162:	8a258593          	addi	a1,a1,-1886 # a00 <lock_release+0x3e>
 166:	4501                	li	a0,0
 ...
 180:	88c50513          	addi	a0,a0,-1908 # a08 <lock_release+0x46>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 504:	52850513          	addi	a0,a0,1320 # a28 <digits>
 508:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5d0:	45cb8b93          	addi	s7,s7,1116 # a28 <digits>
 ...
 710:	31490913          	addi	s2,s2,788 # a20 <lock_release+0x5e>
        while(*s != 0){
...
0000000000000936 <thread_create>:
...
void *thread_create(void*(start_routine)(void*),void *arg)
{
 ...
 94c:	f0a080e7          	jalr	-246(ra) # 852 <malloc>
	if((uint64)stack%4096U)
 950:	03451793          	slli	a5,a0,0x34
 954:	c791                	beqz	a5,960 <thread_create+0x2a>
 956:	0347d713          	srli	a4,a5,0x34
	{
		stack = stack + (4096U - (uint64)stack%4096U);
 95a:	6785                	lui	a5,0x1
 95c:	8f99                	sub	a5,a5,a4
 95e:	953e                	add	a0,a0,a5
	}
	int size = 8;
 ...
 96a:	b46080e7          	jalr	-1210(ra) # 4ac <clone>
 96e:	85aa                	mv	a1,a0
	if(tid<0)
 970:	02055163          	bgez	a0,992 <thread_create+0x5c>
	{
		printf("Clone failed\n",tid);
 974:	00000517          	auipc	a0,0x0
 978:	0cc50513          	addi	a0,a0,204 # a40 <digits+0x18>
 ...
 996:	b22080e7          	jalr	-1246(ra) # 4b4 <texit>

000000000000099a <lock_init>:
...
void lock_acquire(lock_t *lock)
{
 ...
 9b2:	4705                	li	a4,1
 9b4:	87ba                	mv	a5,a4
 9b6:	0cf537af          	amoswap.d.aq	a5,a5,(a0)
 9ba:	ffed                	bnez	a5,9b4 <lock_acquire+0x8>
            ;
}
 9bc:	6422                	ld	s0,8(sp)
