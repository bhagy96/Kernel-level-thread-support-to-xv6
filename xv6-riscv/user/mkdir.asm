...
main(int argc, char *argv[])
{
  ...
  42:	87a58593          	addi	a1,a1,-1926 # 8b8 <lock_release+0x14>
  46:	4509                	li	a0,2
  ...
  60:	87458593          	addi	a1,a1,-1932 # 8d0 <lock_release+0x2c>
  64:	4509                	li	a0,2
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4b2:	44ab8b93          	addi	s7,s7,1098 # 8f8 <digits>
 ...
 5f2:	30290913          	addi	s2,s2,770 # 8f0 <lock_release+0x4c>
        while(*s != 0){
...
0000000000000818 <thread_create>:
...
void *thread_create(void*(start_routine)(void*),void *arg)
{
 ...
 82e:	f0a080e7          	jalr	-246(ra) # 734 <malloc>
	if((uint64)stack%4096U)
 832:	03451793          	slli	a5,a0,0x34
 836:	c791                	beqz	a5,842 <thread_create+0x2a>
 838:	0347d713          	srli	a4,a5,0x34
	{
		stack = stack + (4096U - (uint64)stack%4096U);
 83c:	6785                	lui	a5,0x1
 83e:	8f99                	sub	a5,a5,a4
 840:	953e                	add	a0,a0,a5
	}
	int size = 8;
 ...
 84c:	b46080e7          	jalr	-1210(ra) # 38e <clone>
 850:	85aa                	mv	a1,a0
	if(tid<0)
 852:	02055163          	bgez	a0,874 <thread_create+0x5c>
	{
		printf("Clone failed\n",tid);
 856:	00000517          	auipc	a0,0x0
 85a:	0ba50513          	addi	a0,a0,186 # 910 <digits+0x18>
 85e:	00000097          	auipc	ra,0x0
 862:	e18080e7          	jalr	-488(ra) # 676 <printf>
		return 0;
	}
	texit();
	return 0;
 ...
 878:	b22080e7          	jalr	-1246(ra) # 396 <texit>
...
void lock_acquire(lock_t *lock)
{
 ...
 894:	4705                	li	a4,1
 896:	87ba                	mv	a5,a4
 898:	0cf537af          	amoswap.d.aq	a5,a5,(a0)
 89c:	ffed                	bnez	a5,896 <lock_acquire+0x8>
            ;
}
 89e:	6422                	ld	s0,8(sp)
