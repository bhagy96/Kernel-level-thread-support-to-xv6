...
main(int argc, char *argv[])
{
  ...
  14:	89058593          	addi	a1,a1,-1904 # 8a0 <lock_release+0x14>
  18:	4509                	li	a0,2
  ...
  50:	86c58593          	addi	a1,a1,-1940 # 8b8 <lock_release+0x2c>
  54:	4509                	li	a0,2
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 49a:	442b8b93          	addi	s7,s7,1090 # 8d8 <digits>
 ...
 5da:	2fa90913          	addi	s2,s2,762 # 8d0 <lock_release+0x44>
        while(*s != 0){
...
0000000000000800 <thread_create>:
...
void *thread_create(void*(start_routine)(void*),void *arg)
{
 ...
 816:	f0a080e7          	jalr	-246(ra) # 71c <malloc>
	if((uint64)stack%4096U)
 81a:	03451793          	slli	a5,a0,0x34
 81e:	c791                	beqz	a5,82a <thread_create+0x2a>
 820:	0347d713          	srli	a4,a5,0x34
	{
		stack = stack + (4096U - (uint64)stack%4096U);
 824:	6785                	lui	a5,0x1
 826:	8f99                	sub	a5,a5,a4
 828:	953e                	add	a0,a0,a5
	}
	int size = 8;
 ...
 834:	b46080e7          	jalr	-1210(ra) # 376 <clone>
 838:	85aa                	mv	a1,a0
	if(tid<0)
 83a:	02055163          	bgez	a0,85c <thread_create+0x5c>
	{
		printf("Clone failed\n",tid);
 83e:	00000517          	auipc	a0,0x0
 842:	0b250513          	addi	a0,a0,178 # 8f0 <digits+0x18>
 846:	00000097          	auipc	ra,0x0
 84a:	e18080e7          	jalr	-488(ra) # 65e <printf>
		return 0;
	}
	texit();
	return 0;
 ...
 860:	b22080e7          	jalr	-1246(ra) # 37e <texit>

0000000000000864 <lock_init>:
...
void lock_acquire(lock_t *lock)
{
 ...
 87c:	4705                	li	a4,1
 87e:	87ba                	mv	a5,a4
 880:	0cf537af          	amoswap.d.aq	a5,a5,(a0)
 884:	ffed                	bnez	a5,87e <lock_acquire+0x8>
            ;
}
 886:	6422                	ld	s0,8(sp)
